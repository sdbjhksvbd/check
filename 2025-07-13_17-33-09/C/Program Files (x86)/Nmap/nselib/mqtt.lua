...
--
-- See "3.1 CONNECT â€“ Client requests a connection to a Server"
...
--
-- See "3.2 CONNACK â€“ Acknowledge connection request" section of the
-- standard.
--
...
--
-- See "3.9 SUBACK â€“ Subscribe acknowledgement" section of the
-- standard.
--
-- @param fhflags The flags of the control packet.
-- @param buf The string representing the control packet.
...
--
-- See "3.3 PUBLISH â€“ Publish message" section of the standard.
--
-- @param fhflags The flags of the control packet.
-- @param buf The string representing the control packet.
-- @return
...
--
-- See "3.14 DISCONNECT â€“ Disconnect notification" section of the
-- standard.
--
-- @param options Table of options accepted by this type of control
--        packet.
