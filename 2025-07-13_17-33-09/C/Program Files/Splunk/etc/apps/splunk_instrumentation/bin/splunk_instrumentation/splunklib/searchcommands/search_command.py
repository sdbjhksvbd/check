...
from splunk_instrumentation.splunklib.six.moves import StringIO
from itertools import chain, islice
from splunk_instrumentation.splunklib.six.moves import filter as ifilter, map as imap, zip as izip
...
from splunk_instrumentation.splunklib.six.moves.urllib.parse import unquote
from splunk_instrumentation.splunklib.six.moves.urllib.parse import urlsplit
...
def dispatch(command_class, argv=sys.argv, input_file=sys.stdin, output_file=sys.stdout, module_name=None):
    ...
    **Example**
    ...
    ..  code-block:: python
        ...
        #!/usr/bin/env python
        from splunk_instrumentation.splunklib.searchcommands import dispatch, StreamingCommand, Configuration, Option, validators
        @Configuration()
