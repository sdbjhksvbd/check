...
jwt_expiration = <positive_integer>
* Set the expiration date for JWT by specifying the number of days the token is valid for.
* Provide a value greater than 0 and less than or equal to 30.
* Default: 30
...
deep_link_registration_timeout_secs = <positive_integer>
* Set the TTL in seconds for a deep link registration, used by the deep_link_dashboard modular input.
* Any value greater than 0 and less than 900, Spacebridge invalidates the registration at 15mns.
* Default: 300
