...
async def process_connectivity_test_request(log: logging.Logger,
                                            request_context,
                                            encryption_context,
    ...
    log.info("Connectivity test via https succeeded with code=%s message=%s", response.code, message)
