...
class FeatureState(BaseRestHandler, PersistentServerConnectionApplication):
    ...
    def __init__(self, command_line, command_arg):
        BaseRestHandler.__init__(self, logname="rest_feature_type_configuration")
    ...
    def get(self, request):
        ...
        return get_state_of_app(self.log, feature_name, authtoken)
    ...
    def post(self, request):
        ...
        return set_state_of_app(self.log, feature_name, authtoken, system_authtoken, new_state)
...
def get_state_of_app(log: logging.Logger, app_name, authtoken):
    ...
    log.info('Retrieved state of app for app_type={}, application_state={}'.format(app_name, app_state))
