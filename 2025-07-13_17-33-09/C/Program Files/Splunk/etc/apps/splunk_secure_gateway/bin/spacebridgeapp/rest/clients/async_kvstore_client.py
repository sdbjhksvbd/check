...
class AsyncKvStoreClient(AsyncNonSslClient):
    ...
    def __init__(self, log: logging.Logger, config: SecureGatewayConfig):
        self.timeout_sec = config.get_kv_async_timeout_secs()
        super(AsyncKvStoreClient, self).__init__(log, config)
    ...
    def async_kvstore_get_request(self, collection, auth_header, key_id=None, owner=NOBODY, params=None,
        ...
        return self.async_get_request(uri=uri, params=params, auth_header=auth_header, timeout=self.timeout_sec)
    ...
    def async_kvstore_post_request(self, collection, data, auth_header, key_id=None, owner=NOBODY, params=None):
        ...
        return self.async_post_request(uri=uri, data=data, params=params, auth_header=auth_header, timeout=self.timeout_sec)
    ...
    def async_kvstore_delete_request(self, collection, auth_header, key_id=None, owner=NOBODY, params=None):
        ...
        """
        uri = self.get_kvstore_uri(owner, collection, key_id)
        return self.async_delete_request(uri=uri, params=params, auth_header=auth_header, timeout=self.timeout_sec)
