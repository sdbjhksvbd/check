...
async def dashboard_list_request(log: logging.Logger,
                                 request, async_client_factory, request_context):
    """
    ...
    try:
        ...
        await process_dashboard_list_request(log,
                                             request_context,
...
class DashboardsHandler(async_base_endpoint.AsyncBaseRestHandler):
    ...
    def __init__(self, command_line, command_arg):
        super().__init__(command_line, command_arg, logname="ssg_migration_handler")
    ...
    async def get(self, request):
        ...
        response = await dashboard_list_request(self.log, request, self.async_client_factory, context)
        return {
            PAYLOAD: response,
