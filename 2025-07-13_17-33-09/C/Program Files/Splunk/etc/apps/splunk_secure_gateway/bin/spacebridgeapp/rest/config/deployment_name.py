...
class DeploymentName(BaseRestHandler, PersistentServerConnectionApplication):
    ...
    def __init__(self, command_line, command_arg):
        BaseRestHandler.__init__(self, logname="set_deployment_name")

    def post(self, request):

        payload = json.loads(request[PAYLOAD])

        self.log.info("attempting to set deployment name")
        ...
        try:
            ...
            self.log.exception("Exception setting deployment name={}".format(e))
