...
async def process_udf_hosted_resource_get(log: logging.Logger,
                                          request_context,
    ...
    log.debug("UdfHostedResourceCache Contents: hosted_resource_type=%s, resource_path=%s, resource_type=%s, "
    ...
    log.debug("Processing UdfHostedResourceRequest: "
