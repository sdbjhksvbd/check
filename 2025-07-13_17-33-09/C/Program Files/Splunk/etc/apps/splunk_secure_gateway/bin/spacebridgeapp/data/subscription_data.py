...
from spacebridgeapp.data.dashboard_data import TrellisVisualizationData
...
class TrellisSavedSearchEvent(SpacebridgeAppBase):
    def __init__(self,
                 saved_search_id: str = '',
                 trellis_visualization_data: TrellisVisualizationData= None,
                 dispatch_state: int = DispatchState.NONE.value,
    ...
    def to_protobuf(self):
        ...
        Returns:
            TrellisDashboardVisualizationEvent
        """
        proto = subscription_pb2.TrellisSavedSearchEvent()
        self.set_protobuf(proto)
        return proto
