...
from splapp_protocol import event_handler_pb2
from spacebridgeapp.data.base import SpacebridgeAppBase
from spacebridgeapp.util.constants import VALUE, LABEL, MATCH
...
class Init(SpacebridgeAppBase):
    """
    Container for data for Init element. A change element contains set, unset, eval, link and conditions
    """
