...
def process_trellis_format(log: logging.Logger,
                           search, visualization_data):
    """
    ...
    log.debug("Processing trellis for search={}".format(search, visualization_data))
    trellis_split_by = search.trellis_split_by

    if not visualization_data.field_names or not trellis_split_by:
        log.debug("No visualization data field names=%s or trellis_split_by=%s", visualization_data.field_names, trellis_split_by)
