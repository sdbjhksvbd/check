...
class SubscriptionCleanUp(object):
    ...
    def __init__(self, log: logging.Logger, session_key, clean_up_time):
        """
    ...
    def _clean_user_namespaced_items(self):
        ...
        self.log.debug(f'Deleting credentials older than last_update_time={timestamp_before}, users={len(users)}')
        for owner in users:
