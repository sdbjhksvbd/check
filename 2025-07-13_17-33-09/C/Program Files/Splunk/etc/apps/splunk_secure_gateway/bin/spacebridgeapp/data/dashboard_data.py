...
class DashboardDescription(SpacebridgeAppBase):
    ...
    def __init__(self,
        ...
        self.tags = tags
        self.init = init
        self.environment_tokens = environment_tokens
    ...
    def set_protobuf(self, proto):
        ...
        if self.init is not None:
            proto.init.CopyFrom(self.init.to_protobuf())

        if self.environment_tokens:
            proto.environmentTokens.extend([environment_token.to_protobuf() for environment_token in self.environment_tokens])
...
class EnvironmentToken(SpacebridgeAppBase):
    ...
    def set_protobuf(self, proto):
        ...
        proto.tokenValue = self.token_value

    def to_protobuf(self):
        proto = common_pb2.EnvironmentToken()
        self.set_protobuf(proto)
        return proto
