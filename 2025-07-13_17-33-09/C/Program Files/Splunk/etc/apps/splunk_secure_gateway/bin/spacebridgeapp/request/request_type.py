...
class RequestType(Enum):
    ...
    SNOOZEABLE_ALERTS_GET_REQUEST = "snoozeableAlertsGetRequest"
    REPORT_LIST_REQUEST = "reportListRequest"
    REPORT_SET_REQUEST = "reportSetRequest"
    REPORT_GET_REQUEST = "reportGetRequest"
    NOTIFICATION_MANAGEMENT_REQUEST = "notificationManagementRequest"
