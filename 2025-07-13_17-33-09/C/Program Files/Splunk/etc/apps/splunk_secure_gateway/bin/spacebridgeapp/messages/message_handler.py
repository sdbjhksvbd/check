...
class CloudgatewayMessageHandler(AbstractMessageHandler):
    ...
    async def handle_application_message(self, msg, sender, request_id):
        ...
        try:
            ...
            # process message
            request_context = await process_message(self.logger,
                                                    sender,
            ...
            subscription_update = await post_process_message(self.logger,
                                                             request_context,
                                                             server_application_message,
                                                             self.async_client_factory,
                                                             get_guid
    ...
    async def handle_cloudgateway_message(self, msg):
        ...
        :return:
        """
        await handle_spacebridge_message(self.logger, self.system_auth_header, msg, self.async_client_factory, self.encryption_context)
