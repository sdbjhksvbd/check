...
from spacebridgeapp.data.subscription_data import ServerDashboardVisualizationEvent, ServerDashboardInputSearchEvent, \
    ServerSavedSearchEvent, ServerUdfDatasourceEvent, TrellisDashboardVisualizationEvent, TrellisSavedSearchEvent
...
def build_server_subscription_update(subscription_update, server_subscription_update):
    ...
    elif isinstance(subscription_update, TrellisSavedSearchEvent):
        subscription_update.set_protobuf(server_subscription_update.trellisSavedSearchEvent)
    else:
