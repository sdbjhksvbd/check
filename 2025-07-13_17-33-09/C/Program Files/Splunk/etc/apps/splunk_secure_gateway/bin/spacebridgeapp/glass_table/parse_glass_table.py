...
async def to_dashboard_description(log: logging.Logger, json_object, minimal=False):
    """
    ...
    if isinstance(json_object, dict):
        ...
        definition = UdfDashboardDescription.from_json(log, json_object.get('definition'))
