...
from spacebridgeapp.util.constants import SESSION, AUTHTOKEN, PAYLOAD, STATUS, KEY, QUERY, \
...
class TaggingConfigHandler(BaseRestHandler, PersistentServerConnectionApplication):
    ...
    def __init__(self, command_line, command_arg):
        BaseRestHandler.__init__(self, logname="tagging_config_handler")
    ...
    def post(self, request):
        ...
        try:
            ...
            self.log.info("Failed to set tags, error=%s", str(e))
            return build_error_payload(e)
