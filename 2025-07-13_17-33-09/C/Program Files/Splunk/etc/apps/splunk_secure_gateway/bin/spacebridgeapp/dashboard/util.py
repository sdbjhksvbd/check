...
def build_dashboard_visualization_search(log: logging.Logger,
                                         search_element=None, row_index=0, panel_index=0, dashboard_refresh=None,
                                         show_refresh=True):
    """
    ...
    if search_element is not None:
        ...
        search_handlers = []
        if done:
            done_handler = build_search_handler(log,
                                                search_handler_element=done,
