...
class Integer(Validator):
    ...
    def __init__(self, minimum=None, maximum=None):
        if minimum is not None and maximum is not None:
            ...
            def check_range(value):
                if value < minimum:
                    raise ValueError('Expected integer in the range [{0},+âˆž], not {1}'.format(minimum, value))
                return
        elif maximum is not None:
            def check_range(value):
                if value > maximum:
                    raise ValueError('Expected integer in the range [-âˆž,{0}], not {1}'.format(maximum, value))
                return
        else:
            def check_range(value):
                return
...
class Float(Validator):
    ...
    def __init__(self, minimum=None, maximum=None):
        if minimum is not None and maximum is not None:
            ...
            def check_range(value):
                if value < minimum:
                    raise ValueError('Expected float in the range [{0},+âˆž], not {1}'.format(minimum, value))
                return
        elif maximum is not None:
            def check_range(value):
                if value > maximum:
                    raise ValueError('Expected float in the range [-âˆž,{0}], not {1}'.format(maximum, value))
                return
        else:
            def check_range(value):
                return
