...
import logging
from mc_auto_config import is_autoconfigure_disabled
...
if __name__ == '__main__':
    ...
    if is_autoconfigure_disabled(session_key):
        try:
            disable_dmc_on_shc(session_key)
        except Exception as e:
            logging.exception('DMC is not disabled due to an error: ', str(e))
            raise
