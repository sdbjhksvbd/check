...
logging = logger_manager.setup_logging('pura_remote_dismiss_file')
...
class RemoteDismissFileHandler(PersistentServerConnectionApplication):
    ...
    def write_entry(self, entry):
        ...
        try:
            response, _ = sr.simpleRequest('{}?output_mode=json'.format(pra_dismiss_remote_file_endpoint),
