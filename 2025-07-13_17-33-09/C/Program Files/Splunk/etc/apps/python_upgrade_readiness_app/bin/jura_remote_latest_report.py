...
class RemoteLatestReport:
    ...
    def telemetry_update(self, local_report):
        ...
        try:
            ...
            export_report_details = utils.get_export_report_kvstore_details(self.session_key, scan_type="jquery")
            utils.delete_kvstore_details(self.session_key, jra_remote_export_report_endpoint)
            
            send_email_details = utils.get_send_email_kvstore_details(self.session_key, scan_type="jquery")
            utils.delete_kvstore_details(self.session_key, jra_remote_send_email_endpoint)
            
            page_visits_details = utils.get_page_visits_kvstore_details(self.session_key, scan_type="jquery")
            utils.delete_kvstore_details(self.session_key, jra_page_visits_endpoint)
            ...
            self.telemetry_handler.scan_summary['email_switch'] = {
                'is_jra_email_enabled' : email_notification_switch_data.get('is_jra_email_enabled', 1)
            }
