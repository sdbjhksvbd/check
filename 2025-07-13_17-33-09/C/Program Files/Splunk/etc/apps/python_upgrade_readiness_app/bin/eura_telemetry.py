...
class Telemetry(object):
    ...
    def write_scan_summary(self):
        ...
        try:
            ...
            summary['appSplunk9XUpradeReadinessScanDetails']['export_report'] = self.scan_summary['export_report']
            summary['appSplunk9XUpradeReadinessScanDetails']['send_email'] = self.scan_summary['send_email']
            summary['appSplunk9XUpradeReadinessScanDetails']['page_visits'] = self.scan_summary['page_visits']
            summary['appSplunk9XUpradeReadinessScanDetails']['email_switch'] = self.scan_summary['email_switch']
