...
class Telemetry(object):
    ...
    def write_scan_summary(self):
        ...
        try:
            ...
            summary['appJqueryUpradeReadinessScanDetails']['export_report'] = self.scan_summary['export_report']
            summary['appJqueryUpradeReadinessScanDetails']['send_email'] = self.scan_summary['send_email']
            summary['appJqueryUpradeReadinessScanDetails']['page_visits'] = self.scan_summary['page_visits']
            summary['appJqueryUpradeReadinessScanDetails']['email_switch'] = self.scan_summary['email_switch']
            ...
            apps = utils.update_structure(self.scan_summary, "appJqueryUpradeReadinessScanDetails", False)
