...
logging = logger_manager.setup_logging('pura_remote_result')
...
class RemoteResultHandler(PersistentServerConnectionApplication):
    ...
    def get_remote_result(self, is_remote):
        ...
        filepath = utils.read_latest_report_filepath(scan_type="python", is_remote=is_remote)
        if not filepath:
        ...
        are_dismissed_files_filtered = utils.filter_dismissed_files(latest_report_data, dismiss_file_details, scan_type="python")
