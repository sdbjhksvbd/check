...
class SplunkInternalLibraryCheck:
    ...
    def find_internal_library_in_js(self, js_files, disallowed_list, risky_imports_list):
        """
    ...
    def check_splunk_internal_library(self, app_name, app_path):
        ...
        try:
            ...
            self.find_internal_library_in_js(js_files, disallowed_list, risky_imports_list)
