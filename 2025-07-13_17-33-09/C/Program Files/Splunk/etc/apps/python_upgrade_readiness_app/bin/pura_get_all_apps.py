...
BASE_URL = "https://cdn.splunkbase.splunk.com/public/report/apps_dump.json"
...
MESSAGE_EXCEPTION_GET_LATEST_FILE = 'Exception fetching the latest file: {}'
MESSAGE_EXCEPTION_GET_CSV_APPS = 'Exception fetching the apps from csv: {}'
...
def get_apps():
    ...
    """
    try:
        logging.info("Initial call to splunkbase API")
...
if __name__ == "__main__":
    random_num = random.uniform(0,1200)
    logging.info("Fetching apps after {} secs".format(random_num))
