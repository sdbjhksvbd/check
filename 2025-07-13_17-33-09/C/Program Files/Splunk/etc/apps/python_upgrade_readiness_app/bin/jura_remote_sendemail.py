...
logging = logger_manager.setup_logging('jura_remote_sendemail')
...
class RemoteSendEmailHandler(PersistentServerConnectionApplication):
    ...
    def post_remote_sendemail(self, is_remote):
        ...
        are_dismissed_files_filtered = utils.filter_dismissed_files(report, dismiss_file_details, scan_type="jquery")
        ...
        attachment_name = JQUERY_EMAIL_ATTACHMENT_NAME.format(self.app_name, str(self.host))
    ...
    def write_entry(self, entry):
        ...
        try:
            response, _ = sr.simpleRequest('{}?output_mode=json'.format(jra_remote_send_email_endpoint),
