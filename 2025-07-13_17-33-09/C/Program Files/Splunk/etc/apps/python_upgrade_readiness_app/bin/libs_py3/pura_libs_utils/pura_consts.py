...
UPGRADE_READINESS_APP_VERSION = "4.3.0"
...
ALL_APPS_NAME_TELEMETRY = "URA_ALL_APPS"
...
DISMISSED_BY_USER = "UNKNOWN"

BODY = "Hello Splunk Admin,<br/><br/>"\
    "The Upgrade Readiness App detected <b>{} {} with deprecated {}</b> on the <b><a>{}</a></b> instance.<br/><br/> {}"\
...
EMERALD_EMAIL_BODY = "Hello Splunk Admin,<br/><br/>"\
    "The Upgrade Readiness App detected <b>{} that may need {} to be compatible with Splunk Enterprise 9.0 </b> on the <b><a>{}</a></b> instance.<br/><br/> {}"\
...
JQUERY_REQUIRED_ACTION_SPLUNKBASE_OTHERS = "Do one of the following:Confirm on the app's Splunkbase listing if this alert should be dismissed for this app version.;" \
...
PYTHON_REQUIRED_ACTION_SPLUNKBASE = "Do one of the following:"\
                                    ...
                                    "Uninstall the app from the app listing page.;"\
                                    "Take ownership of the app and override existing code (not recommended)."
PYTHON_REQUIRED_ACTION_SPLUNKBASE_WARN = "Please check again in 24 hours when the necessary scan is complete."
...
pra_remote_export_report_endpoint = "/servicesNS/nobody/python_upgrade_readiness_app/storage/collections/data/pra_remote_export_report"
pra_remote_send_email_endpoint = "/servicesNS/nobody/python_upgrade_readiness_app/storage/collections/data/pra_remote_send_email"
pra_page_visits_endpoint = "/servicesNS/nobody/python_upgrade_readiness_app/storage/collections/data/pra_page_visits"
...
get_schedule_scan_interval_endpoint = "/servicesNS/nobody/python_upgrade_readiness_app/configs/inputs/script%3A%252F%252F{}"
...
pra_email_receivers_list_endpoint = "/servicesNS/nobody/python_upgrade_readiness_app/storage/collections/data/pra_email_receivers_list"
...
jra_remote_export_report_endpoint = "/servicesNS/nobody/python_upgrade_readiness_app/storage/collections/data/jra_remote_export_report"
jra_remote_send_email_endpoint = "/servicesNS/nobody/python_upgrade_readiness_app/storage/collections/data/jra_remote_send_email"
jra_page_visits_endpoint = "/servicesNS/nobody/python_upgrade_readiness_app/storage/collections/data/jra_page_visits"
...
jra_email_receivers_list_endpoint = "/servicesNS/nobody/python_upgrade_readiness_app/storage/collections/data/jra_email_receivers_list"
...
era_remote_export_report_endpoint = "/servicesNS/nobody/python_upgrade_readiness_app/storage/collections/data/era_remote_export_report"
era_remote_send_email_endpoint = "/servicesNS/nobody/python_upgrade_readiness_app/storage/collections/data/era_remote_send_email"
era_page_visits_endpoint = "/servicesNS/nobody/python_upgrade_readiness_app/storage/collections/data/era_page_visits"
...
era_email_receivers_list_endpoint = "/servicesNS/nobody/python_upgrade_readiness_app/storage/collections/data/era_email_receivers_list"
...
SYSTEM_APPS = ['search', 'splunk_archiver', 'splunk_instrumentation', 'splunk_monitoring_console', 'learned',
               ...
               'splunk_product_guidance', 'splunk_assist', 'splunk_essentials_9_0', 'search_artifacts_helper', 'missioncontrol']
...
MESSAGE_EXCEPTION_WRITING_REMOTE_EXPORT_REPORT_ENTRY = "Exception while writing application export report entry on host: {}"
MESSAGE_ERROR_WRITING_REMOTE_EXPORT_REPORT_ENTRY = "Error writing application export report entry on host: {}"
MESSAGE_REMOTE_EXPORT_REPORT_ENTRY_SUCCESS = "Successfully registered for exporting the report on host: {}."
MESSAGE_EXCEPTION_WRITING_REMOTE_SEND_EMAIL_ENTRY = "Exception while writing application send email entry on host: {}"
MESSAGE_ERROR_WRITING_REMOTE_SEND_EMAIL_ENTRY = "Error writing application send email entry on host: {}"
MESSAGE_REMOTE_SEND_EMAIL_ENTRY_SUCCESS = "App: {} successfully registered for sending the email on host: {}."
...
MESSAGE_ERROR_KVSTORE_DELETE = "Error occurred while reading from kvstore for endpoint: {}"
MESSAGE_EXCEPTION_KVSTORE_DELETE = "Exception occurred while reading from kvstore for endpoint: {} exception: {}"
