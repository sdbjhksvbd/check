...
class SearchPeerSSLConfig:
    ...
    def add_warning_message(self, required_action):
        ...
        """
        self.report['summary']['Status'] = CHECK_CONST_WARNING
    ...
    def verify_config_param_set(self):
        ...
        return {"requireClientCert": requireClientCert, "sslVerifyServerCert": sslVerifyServerCert}
    ...
    def check_search_peer_ssl_config(self,):
        ...
        try:
            ...
            if (requireClientCert == "0") or (sslVerifyServerCert == "0"):
