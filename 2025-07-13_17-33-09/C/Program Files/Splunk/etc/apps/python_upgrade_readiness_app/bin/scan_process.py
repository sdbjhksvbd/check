...
class ScanProcess(object):
            ...
            for dirs, subdirs, files in os.walk(dir_path):
                ...
                for subdir in subdirs:
                    if subdir == "splunklib":
                        ...
                        if LooseVersion(splunklib_version) >= LooseVersion("1.7.2"):
    ...
    def quake_response(self, app, app_meta, app_status, app_path):
        ...
        if app_status == CHECK_CONST_PASSED:
            ...
            elif (app_meta[0] == CONST_SPLUNKBASE_NONE):
                app_report['details'] = 'This app is not compatible with Python 3.'
                app_report['required_action'] = PYTHON_REQUIRED_ACTION_SPLUNKBASE
            elif (app_meta[0] == CONST_SPLUNKBASE_WARN):
                app_report['details'] = 'This newly installed App has not completed the necessary scan.' 
                app_report['required_action'] = PYTHON_REQUIRED_ACTION_SPLUNKBASE_WARN
