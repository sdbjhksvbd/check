...
from assist.util import append_lib_to_pythonpath, var_assist_path, is_assist_path
...
def handle_get(log: logging.Logger, asset_root: str, asset_path: str) -> HttpResponse:
    ...
    if not is_assist_path(asset_root):
        return HttpResponse(HTTPStatus.INTERNAL_SERVER_ERROR, HttpResult.ERROR, {}, {'message': 'asset configuration invalid'})
