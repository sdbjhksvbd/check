...
_CLUSTER_MODE_MASTER = 'master'  # Deprecated since Splunk v.9.0
_CLUSTER_MODE_MANAGER = 'manager'  # Introduced in Splunk v.9.0
...
_ROLE_LICENSE_MANAGER = 'license_manager'  # Introduced in Splunk v.9.0
_ROLE_LICENSE_MASTER = 'license_master'  # Deprecated since Splunk v.9.0
_ROLE_CLUSTER_MANAGER = 'cluster_manager'  # Introduced in Splunk v.9.0
_ROLE_CLUSTER_MASTER = 'cluster_master'  # Deprecated since Splunk v.9.0
_ROLE_DEPLOYMENT_SERVER = 'deployment_server'

_ACCEPTED_CLUSTER_MODES = [_CLUSTER_MODE_DISABLED, _CLUSTER_MODE_MANAGER, _CLUSTER_MODE_MASTER, _CLUSTER_MODE_SEARCHHEAD]
_ACCEPTED_SERVER_ROLES = [_ROLE_SEARCH_HEAD, _ROLE_KV_STORE, _ROLE_SHC_DEPLOYER, _ROLE_LICENSE_MANAGER,
                          _ROLE_LICENSE_MASTER, _ROLE_CLUSTER_MANAGER, _ROLE_CLUSTER_MASTER, _ROLE_DEPLOYMENT_SERVER]
...
def get_server_roles(log: logging.Logger, session_key) -> List[str]:
    ...
    log.debug("Fetched server roles, roles=%r", roles)
    return roles
...
def get_cluster_mode(log: logging.Logger, session_key):
    ...
    log.debug("Fetched cluster mode, mode=%r", mode)
    return mode
