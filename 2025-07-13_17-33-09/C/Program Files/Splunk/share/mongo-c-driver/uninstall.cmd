...
pushd C:\builds\splcore\main\build_home\splunk\
...
cd ..
echo Removing top-level installation directory: C:\builds\splcore\main\build_home\splunk\
(rmdir C:\builds\splcore\main\build_home\splunk\ 2>NUL) || echo ... not removed (probably not empty)
