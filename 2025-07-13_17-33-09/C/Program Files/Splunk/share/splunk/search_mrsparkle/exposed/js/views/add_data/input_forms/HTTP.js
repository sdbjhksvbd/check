            ...
            faqList: function(generalHelpLink, defaultsHelpLink) {
                var faqList = [
                    ...
                    },
                    {
                        ...
                        answer: _('Enable the collector on this page. Provide a name for the token (all other fields are optional.) After saving, configure your logging client with the token that the Splunk platform displays to send data to the collector in a specific format.').t() +' '+ '<a class="external" href="' + generalHelpLink + '" target="_blank" rel="noopener noreferrer">' + _('Learn more').t() + '</a>'
                    },
                    {
                        question: _('How do I view and configure the tokens that I can use to send data to the HTTP Event Collector?').t(),
                        answer: _('You can use the HTTP Event Collector management page to view, enable, disable, and configure token defaults (like source type and default index.)').t() +' '+ '<a class="external" href="' + defaultsHelpLink + '" target="_blank" rel="noopener noreferrer">' + _('Learn more').t() + '</a>'
                    },
                    {
