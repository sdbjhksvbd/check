                ...
                <div class="list-summary" data-col-index=<%- colIndex %> >\
                    <% _.each(metrics, function(metric) { %>\
                        ...
                        <div class="list-summary-row <% if (metric.breakAfter) { %>list-summary-row-last <% } %>">\
                            <div class="list-summary-label <% if (isTypeAggregate) { %>list-summary-aggregate <% } %>\
                            <%- metric.className ? metric.className.toLowerCase() : \'\' %> <% if (metric.isZero) {%> summary-zero <% } %>" >\
                                ...
                                <div class="list-summary-value-label">\
                                    <%- metric.label %> \
                                </div>\
                            </div>\
                        </div>\
