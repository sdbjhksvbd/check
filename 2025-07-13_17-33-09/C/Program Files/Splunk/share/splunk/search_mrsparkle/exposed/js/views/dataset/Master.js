        ...
        return BaseView.extend({
            ...
            initialize: function() {
                ...
                this.children.timeRangePicker = new TimeRangePicker({
                    ...
                    className: 'controls',
                    timerangeClassName: 'btn pull-left',
                    dialogOptions: {
            ...
            initializeNavTab: function() {
                ...
                this.children.navtab.deactivate({ deep: true });
            },
            activate: function(options) {
                ...
                if (!this.children.navtab) {
                    this.initializeNavTab();
                    this.children.navtab.activate({ deep: true });
                }

                this.children.jobStatus.options.showControlsAndJobInfo = this.model.searchJob.id;
                if (this.$el.html()) {
                    if (!this.children.jobStatus.$el.html()) {
                        this.children.jobStatus.activate({ deep: true }).render().appendTo(this.$('.job-status-container'));
                    }
                    if (!this.children.navtab.$el.html()) {
                        this.children.navtab.activate({ deep: true }).render().appendTo(this.$('.job-status-container'));
                    }
                } else {
            ...
            deactivate: function(options) {
                ...
                this.children.navtab.remove();
                delete this.children.navtab;
            ...
            render: function() {
                ...
                if (!html) {
                    ...
                    this.children.navtab.render().appendTo(this.$('.job-status-container'));
