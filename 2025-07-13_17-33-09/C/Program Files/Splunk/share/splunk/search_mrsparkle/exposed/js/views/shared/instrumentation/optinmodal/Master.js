                ...
                <div class="message-container">\
                    <div class="usage-details upgrade">\
                        <p>\
                            ...
                            <a class="learn-more-link" href="<%= settingsPageUrl %>" target="_blank" rel="noopener noreferrer">\
                    ...
                    <div class="privacy-details">\
                        <a class="learn-more-link external" href="<% instrumentationLink %>" target="_blank" rel="noopener noreferrer">\
                            <%= _("Learn more").t() %>\
                        </a>\
                        ...
                        <a class="learn-more-link external" href="http://www.splunk.com/r/privacy" target="_blank" rel="noopener noreferrer">\
