define(
    ...
    function(
        ...
        return BaseView.extend({
            ...
            events: {
                'click a.explore_link': function(e) {
                    var linkname = e.currentTarget.innerHTML,
            ...
            template: '\
                <% if (canPivot) { %>\
                    <li><a class="explore_link" data-type="<%= type %>" href="<%= pivotLink %>">\
                        <%- _("Visualize with Pivot").t() %></a></li>\
                <% } %>\
                <% if (canSearch) { %>\
                    <li><a class="explore_link" data-type="<%= type %>" href="<%= searchLink %>">\
                        <%- _("Investigate in Search").t() %></a></li>\
                <% } %>\
            '
        });
    }
