define([
    ...
    function(
        ...
        DMC_ERROR_MESSAGES = {
            ...
            'AppInstall_SplunkbaseAppIDConflict': _('Install failed: App has the same id as a public app. ' +
                'Update this private app with a unique id to remove this conflict.').t(),
        ...
        LARGE_PACKAGE_ERROR_MESSAGE = _('Upload failed: Package is too large, must be less than 512MB.').t(),
