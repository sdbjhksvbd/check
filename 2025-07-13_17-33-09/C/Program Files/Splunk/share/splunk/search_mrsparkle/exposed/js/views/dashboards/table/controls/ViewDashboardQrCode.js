        ...
        return Modal.extend({
            ...
            render: function () {
                ...
                this.$(Modal.BODY_SELECTOR).append(
                    '<div class="' + css.qrBox + '" ><div class="' + css.qrImageBox + '" >' +
                    '<img class="' + css.qrImage + '" alt="' + _("QR image").t() + '" src="' +
                    this.model.qrUrl + 'png?dashboard_id=' + qrTargetUrl + '" \></div>' +
                    '<div class="' + css.downloadButtonsBox + '" ></div></div>');
