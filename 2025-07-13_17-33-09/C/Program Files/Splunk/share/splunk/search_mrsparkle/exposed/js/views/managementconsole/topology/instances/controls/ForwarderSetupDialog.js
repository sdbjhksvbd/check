    ...
    function(
        ...
        return Modal.extend({
            ...
            template: '\
    			...
    			<a class="external" href="<%- helpLink %>" target="_blank" rel="noopener noreferrer">\
    			<%- _("Learn more.").t()%>\
    			</a>\
            	</div><br>\
	            	...
	            	<div class="tab-pane nix-forwarders">\
            			<ol class="instruction-list">\
            			    <li style="padding-top: 5px;padding-bottom: 5px">Download the Splunk universal forwarder from\
                                <a class="doc-link" href="http://www.splunk.com/download/universalforwarder" target="_blank" rel="noopener noreferrer"> Splunk Downloads web page <i class="icon-external"></i></a> . Install and start the universal forwarder on one or more machines in your network.\
                            </li>\
