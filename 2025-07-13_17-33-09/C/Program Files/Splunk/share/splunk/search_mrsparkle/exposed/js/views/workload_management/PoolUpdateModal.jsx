                ...
                <Modal.Body>
                    ...
                    {poolUpdateModalState.edit ?
                        <ControlGroup
                            ...
                            data-test-name="PoolCategory"
                        >
                            <StaticContent
                                data-test-name="static-content-category"
                            >
                    ...
                    :
                        <ControlGroup
                            labelWidth={labelWidth}
                            label={_('Pool Category').t()}
                            data-test-name="PoolUpdateCategory"
                        ...
                        >
                            ...
                            >
                                ...
                                <StaticContent
                                    data-test-name="static-content-miscHelpTxt"
                    ...
                    <ControlGroup
                        ...
                        data-test-name="PoolUpdateCPUWeight"
                    ...
                    <StaticContent
                        data-test-name="static-content-allocated-cpu"
                    ...
                    <ControlGroup
                        ...
                        data-test-name="PoolUpdateMemoryGroup"
                    ...
                    <StaticContent
                        data-test-name="static-content-allocated-mem"
                        className={css.dynamicAllocated}
                    >
                    ...
                    <ControlGroup
                        ...
                        data-test-name="PoolUpdateDefaultPool"
