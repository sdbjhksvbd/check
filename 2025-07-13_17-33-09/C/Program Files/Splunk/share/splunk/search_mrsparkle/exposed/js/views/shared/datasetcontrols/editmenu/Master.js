        ...
        return BaseView.extend({
            ...
            render: function() {
                ...
                if (canWrite || this.options.showOpenActions || canDelete) {
                    this.$el.append('<a class="dropdown-toggle edit' + (this.options.button ? " btn" : "") + (this.options.buttonClass ? " " + this.options.buttonClass : "") + '" href="#">' + _("Edit").t() +'<span class="caret"></span></a>');
                }
