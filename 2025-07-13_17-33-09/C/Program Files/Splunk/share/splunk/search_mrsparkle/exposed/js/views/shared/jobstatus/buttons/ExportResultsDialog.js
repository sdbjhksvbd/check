define([
    ...
    return Modal.extend({
        ...
        initialize: function(options) {
            ...
            $.when(this.deferredPdfAvailable).done(function(available) {
                var items = [
                    {
                        label: _('CSV').t(),
                        value: 'csv'
        ...
        exportResults: function() {
            ...
            if (format === 'pdf') {
                ...
                pdfUtils.downloadReportFromXML(
                    null,
        ...
        events: $.extend({}, Modal.prototype.events, {
            'click .btn-primary': function(e) {
                ...
                splunkUtil.trackPageInteraction(this.model.application.get('app'), 'Click Export Job Link and Export');
                e.preventDefault();
            },
            'click .btn-secondary': function (e) {
                splunkUtil.trackPageInteraction(this.model.application.get('app'), 'Click Export Job Link and Cancel');
            }
        }),
        ...
        render : function() {
            $.when(this.deferredInitializeFormat).done(function() {
        ...
        reRunMessageTemplate:
            '<div class="rerun-msg">\
                <%- reRunMessage %>\
                <a href="<%- learnMoreLink %>" target="_blank" rel="noopener noreferrer" aria-label="<%-  ariaLabel %>">\
