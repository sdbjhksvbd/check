    ...
    function(
        ...
        return Modal.extend({
            ...
            render: function() {
                ...
                this.$(Modal.FOOTER_SELECTOR).prepend('<a target="_blank" rel="noopener noreferrer" href="http://www.splunk.com/goto/estore" class="btn get-license-btn">' + _('Get License').t() + '</a>');
