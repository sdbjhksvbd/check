        ...
        initialize: function(options) {
            ...
            this.children.acceleration = new ControlGroup({
                ...
                help: _('Acceleration might increase storage and processing costs. ').t() +
                      ...
                      '<a href="' + _.escape(accelerateSearchHelpLink) + '" target="_blank" rel="noopener noreferrer">' + _("Learn More").t() + ' <i class="icon-external"></i></a>'
            });
            ...
            'click .save.modal-btn-primary': function(e) {
                this.model.inmem.save({}, {
                    success: function(model, response) {
                        ...
                        splunkUtil.trackPageInteraction(
                            this.model.application.get('app'),
                            'Click Edit Acceleration and Save',
                            {
                                name: hashUtils.hashSha256(this.model.inmem.entry.get('name'))
                            });
                        this.remove();
