define(function(require, exports, module) {
    ...
    var ready = function(name, req, onLoad, config) {
        ...
        var deps = ['splunkjs/mvc/visualizationloader!'];
    ...
    ready._getRequire = function () {
        if (ready.requireFn) {
            return ready.requireFn;
        } else if (typeof __non_webpack_require__ !== 'undefined') {
            // fall back to use webpack's global require
            return __non_webpack_require__;
        }
        throw Error('requireFn must be passed in or not used in a webpack context. You are likely using this file incorrectly.');
    };
