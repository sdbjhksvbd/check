        ...
        return PopTartView.extend({
            ...
            render: function() {
                var canWrite = this.model.dataset.canWrite(),
                    ...
                    canTable = this.model.dataset.canTable(),
                ...
                if (canWrite) {
                    ...
                    if (canEditDescription) {
                        this.$('.edit_actions').append('<li><a class="edit-description" href="#">' + _("Edit Title or Description").t() + '</a></li>');
                    }
                ...
                if (!canFetchDelete && !canDelete && !canTable && !showScheduleLink && !canClone) {
