...
define(function(require, exports, module) {
    ...
    _.extend(MVCConstructor.prototype, Backbone.Events, /** @lends splunkjs.mvc.MVC.prototype */{
        ...
        drilldown: function(path, data) {
            ...
            this.setLocationHref(path);
        },

        setLocationHref: function(path) {
        ...
        loadDrilldown: function(data) {
            ...
            var args = this.deParamArgs(queryArgs, args);
        ...
        deParamArgs: function(queryArgs, data) {
            return _.extend({}, SplunkUtil.queryStringToProp(queryArgs), data);
        },
         ...
         * <a href="http://dev.splunk.com/view/SP-CAAAEWY" target="_blank" rel="noopener noreferrer">Token sytax</a>.
         *
        ...
        /**
         * Returns a transformed value. For details, see <a href="http://dev.splunk.com/view/SP-CAAAEW4" target="_blank" rel="noopener noreferrer">Transform and validate tokens</a>.
         *
