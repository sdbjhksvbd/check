        ...
        return BaseView.extend({
            ...
            initialize: function() {
                ...
                this.children.clientsSummary = new ClientsSummaryView({
                    collection: {
                        phonedHomeClients: this.collection.phonedHomeClients,
                        deploymentErrorClients: this.collection.deploymentErrorClients,
                        recentDownloadClients: this.collection.recentDownloadClients
                    }}); 
