...
define([
    ...
    return VisualizationBase.extend({
        ...
        syncFormatAndMetadata: function() {
            ...
            _(relationship).each(function(formatKey, metadataKey) {
                ...
                this.listenTo(this.model.searchDataParams, 'change:' + metadataKey, function(model, newVal) {
                    // Don't use strict inequality as count can be number and string
        ...
        onConfigChange: function(changedAttributes) {
            ...
            } else if (this._areFormattersDeserialized) {
                var isStatisticsFormatChanged = _.some(changedAttributes, function(value, key) {
                    return key.indexOf("display.statistics.format.") !== -1;
                });
                if (isStatisticsFormatChanged) {
                    this._areFormattersDeserialized = false;
                }
            }
        },
        ...
        updateView: function() {
            ...
            if(this.dataFields.length > 0 && this.dataRows.length > 0) {
                ...
                if (!this._areFormattersDeserialized) {
                    ...
                    // Reinitialize to avoid duplicate format cell renderer
                    this._formatCellRenderers = [];
