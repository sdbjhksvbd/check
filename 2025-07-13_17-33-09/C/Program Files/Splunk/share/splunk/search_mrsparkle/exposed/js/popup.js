...
Splunk.Popup = $.klass({
    ...
    initialize: function(contents, options) {
        ...
        if ( this._options['inlineMode'] ) {
            ...
            this._popup = $('<div class="popupContainer"></div>')
                .append('<div class="splHeader splHeader-popup"><a href="javascript:void(0)" class="splIcon splIcon-close"></a><h1>' + this._options['title'] + '</h1></div>')
    ...
    setPopupContents: function(popupContents){
            ...
            var ieIE = (/msie|trident/i).test(navigator.userAgent);
            if (ieIE) {
...
Splunk.Popup.IFramer = function(path, title, options) {
    ...
    iframe.on('load', function(){//observer load of iframe
