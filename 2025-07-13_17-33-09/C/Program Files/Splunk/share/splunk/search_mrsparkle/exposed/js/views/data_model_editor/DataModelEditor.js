...
define([
    ...
    return BaseView.extend({
        ...
        render: function() {
            ...
            if (this.model.dataModel.getSourceGUID()) {
                this.children.flashMessagesView.flashMsgHelper.addGeneralMessage(CONSTS.EDIT_ACCELERATED_MODEL_ID,
                    { type: splunkDUtils.WARNING,
                       html: _("This Data Model cannot be edited because a source GUID is specified. " +
                               "Remove the source GUID stanza in order to edit the Data Model.").t()});
	        } else if (this.model.dataModel.isAccelerated()) {
                this.children.flashMessagesView.flashMsgHelper.addGeneralMessage(CONSTS.EDIT_ACCELERATED_MODEL_ID,
                    { type: splunkDUtils.WARNING,
                ...
                <div class="header-button-holder pull-right">\
                    <div class="btn-group">\
                        ...
                        <% if (canDownloadDataModel) { %>\
                            <a href="#" class="download-button btn" target="_blank" rel="noopener noreferrer" download="<%-modelName%>.json"><%- _("Download").t() %></a>\
                        <% } %>\
                        <a href="#" class="pivot-model btn"><%- _("Pivot").t() %></a>\
                        <a href="<%- docUrl %>" target="_blank" rel="noopener noreferrer" class="help-link btn"><%- _("Documentation").t() %> <i class="icon-external"></i></a>\
                    </div>\
                </div>\
            ...
            <div class="section-wrapper">\
                ...
                <div class="object-list sidebar">\
                    <div class="object-list-header">\
                        <h2 class="title"><%- _("Datasets").t() %></h2>\
