            ...
            initialize: function(options) {
                ...
                this.children.customWindow = new ControlGroup({
                    ...
                    help: '<span>' + _('Examples: -1d, -3m, 246925704.000, 905293704').t()  +
                            '</span> <a class="learn-more-link" href="' + _.escape(timeRangeHelpLink) + '" target="_blank" rel="noopener noreferrer">' + _('Learn More').t() + ' <i class="icon-external"></i></a>'
                });
            ...
            bodyTemplate: '\
                ...
                <div class="advanced-settings">\
                    <div class="advanced-settings-warning"><%- _("Change the following settings only if you are experiencing summary creation issues.").t() %>\
                        <a class="learn-more-link" href="#" target="_blank" rel="noopener noreferrer"><%- _("Learn More").t() %><i class="icon-external"></i></a>\
                    </div>\
