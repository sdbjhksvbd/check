        ...
        )
    {
        return BaseRouter.extend({
            ...
            page: function(locale, app, page) {
                ...
                $.when(transformsLookupsFetch, appLocalsFetch, appLocalFetch, userFetch, vixFetch, archivesFetch, searchBNFsFetch, this.deferreds.pageViewRendered, this.deferreds.workloadManagementStatus).done(_(function() {
                    ...
                    this.classicUrl.fetch({silentClear: true}).done(_(function() {
                        ...
                        if (this.currentDataModelName != modelName) {
                            ...
                            if (!this.dataModel.validateModel(modelName)){
