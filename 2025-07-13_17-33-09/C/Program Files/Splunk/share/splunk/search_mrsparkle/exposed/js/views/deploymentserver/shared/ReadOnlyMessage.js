    ...
    ['module', 'views/Base', 'underscore', 'uri/route'],
         ...
         return BaseView.extend({
            ...
            render: function() {
                ...
                this.$el.html("<i class='icon-alert'></i>" + _("The forwarder management interface does not support some ").t() + "<a href='" + searchUrl + "'>" + _("settings").t() + "</a>" + _(" in your serverclass.conf file. The interface is now read-only.").t() + " <a href='" + docUrl + "' target='_blank' rel='noopener noreferrer' class='external'>" + _("Learn More").t() + "</a>");
                return this; 
            }
        }); 
});
