        ...
        var appModel = ConfigurationModel.extend(
            {
                ...
                getReleaseNotesURI: function() {
                    var manifest = this.entry.get('manifest');
                    return (manifest && manifest.info && manifest.info.releaseNotes && manifest.info.releaseNotes.uri) || null;
                },
