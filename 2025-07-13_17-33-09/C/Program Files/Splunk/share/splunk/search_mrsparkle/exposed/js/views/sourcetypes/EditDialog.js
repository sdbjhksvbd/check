    ...
    function(
        ...
        return Modal.extend({
            ...
            initialize: function(options) {
                ...
                this.isSingleInstanceCloud = options.isSingleInstanceCloud || false;
            ...
            dialogFormBodyTemplate: '\
                ...
                <div class="extractions-warning">\
                    ...
                    <a class="extractions learn-more-extractions-warning external" href="/help?location=settings.sourcetype.fieldextraction" target="_blank" rel="noopener noreferrer"><%- _("Learn More").t() %></a>\
                </div>\
