        ...
        return BaseView.extend({
            ...
            faqList: function(){
                ...
                },
                {
                    ...
                    answer: _('You can use the Splunk Web platform or edit configuration files to change the deployment server configuration. ').t() + '<a href="' + arguments[0] + '" class="external learn-more-link" target="_blank" rel="noopener noreferrer">' + _("Learn More.").t() + '</a>'
                },
                {
                    question: _('How do I manage deployment clients?').t(),
                    answer: _('Use forwarder management to manage deployment clients. ').t() + '<a href="' + arguments[1] + '" class="external learn-more-link" target="_blank" rel="noopener noreferrer">' + _("Learn More").t() + '</a>'
                },
                {
                    question: _('How many deployment clients are supported by this instance?').t(),
                    answer: _('This instance supports up to 300 deployment clients provided it has the hardware configuration recommended by Splunk. ').t() + '<a href="' + arguments[2] + '" class="external learn-more-link" target="_blank" rel="noopener noreferrer">' + _("Learn More").t() + '</a>'
                },
                {
