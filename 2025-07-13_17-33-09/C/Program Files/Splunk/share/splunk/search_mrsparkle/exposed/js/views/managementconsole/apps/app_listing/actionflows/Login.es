...
export default LoginView.extend({
    ...
    template:
        ...
        '<p class="rights">' +
        '<a target="_blank" rel="noopener noreferrer" class="license-agreement" id="splunk-base-link"></a>' +
        '<%- _(" is governed by the following license: ").t() %>' +
        '<a target="_blank" rel="noopener noreferrer" class="license-agreement" id="app-license"></a></p>' +
