                ...
                successfulClients.fetch({
                                ...
                                success: function(successfulClients, response){
                                    ...
                                    if (numSelectedClients) {
                                        // SPL-186428 toFixed(1) will limit the division to 1 fraction. e.g. 0.4 instead of 0.45. Hence we will show 40% instead of 45%
                                        percentage = i18n.format_percent((numSuccessfulClients/numSelectedClients).toFixed(1));
                                    } else {
                                        percentage = 'N/A'; 
                                    }
