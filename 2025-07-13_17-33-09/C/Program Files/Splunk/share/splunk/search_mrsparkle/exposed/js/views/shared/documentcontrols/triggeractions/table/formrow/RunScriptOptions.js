    ...
    function(_,
        ...
        var DeprecationNotice = Base.extend({
            ...
            template: '' +
                    ...
                    '<a href="<%- helpLink %>" target="_blank" rel="noopener noreferrer" title="<%- _("Splunk Help").t() %>">' +
        ...
        return Base.extend({
            ...
            initialize: function() {
                ...
                this.children.scriptFile = new ControlGroup({
                    ...
                    label: _('File name').t(),
                    help: splunkUtil.sprintf(_('Located in %s or %s').t(), '$SPLUNK_HOME/bin/scripts', '$SPLUNK_HOME/etc/apps/'+ this.model.application.get('app') + '/bin/scripts')
                });
            },
            render: function()  {
