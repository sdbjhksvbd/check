            ...
            */
            ...
            render: function() {
                ...
                if (this.model.report.isPivotReport()) {
                    ...
                    if (this.showLinks) {
                        createdByAnchor = '<a href="' + createdByRoute +'" target="_blank" rel="noopener noreferrer">' + _("Pivot").t() +'</a>';
                    } else {
                    ...
                    if (this.showLinks){
                        createdByAnchor = '<a href="' + createdByRoute +'" target="_blank" rel="noopener noreferrer">' + _("Search").t() +'</a>';
                    } else {
