define(
    ...
    function(_, module, Base, IntroAndCommand, Notices, splunkUtils) {
        return Base.extend({
            ...
            template: '\
                <div class="search-assistant-autoopen-wrapper"><a class="search-assistant-autoopen-toggle btn-pill" aria-label="<%= _("Search Assistant Button").t() %>" href="#"><i></i><%= _("Auto Open").t() %></a></div>\
            '
        });
    }
);
