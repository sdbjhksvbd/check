        ...
        return BaseContentView.extend({
            ...
            openIndexPicker: function() {
                ...
                this.children.indexList = new ListPickerOverlay({
                    ...
                    header: _('Select an index').t(),
                    selectMessage: _('Filter indexes').t(),
                    ...
                    marginTop: this.model.command.editorValues.length ? $('.index-and-sourcetypes').height() : 0,
                    border: cssFile.border,
                    name: 'index'
                });
            ...
            openSourcetypePicker: function() {
                ...
                this.children.sourcetypeList = new ListPickerOverlay({
                    ...
                    header: _('Select one or more sourcetypes').t(),
                    multiselectMessage: _('Filter sourcetypes').t(),
                    allMessage: _("all sourcetypes").t(),
                ...
                this.listenTo(this.children.sourcetypeList, 'listPickerBackSelected', this.openIndexPicker);
            },
            ...
            render: function() {
                ...
                this.appendButtonRow();

                return this;
            },

            template: '\
                <div class="index-and-sourcetypes">\
                    <h3 class="header"><%= _("Selected Data").t() %></h3>\
                    <div class="index-and-sourcetypes-rows"></div>\
                </div>\
                <a href="#" class="add-index-and-sourcetypes bold">\
                    <i class="icon-plus"></i>\
                    <%= _("Add more indexes and sourcetypes").t() %>\
                </a>\
            '
        });
    }
