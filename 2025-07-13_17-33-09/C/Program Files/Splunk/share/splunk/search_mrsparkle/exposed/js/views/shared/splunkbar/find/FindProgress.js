    ...
    return PopTartView.extend({
        ...
        <% if (rawSearch) { %>\
            <ul class="<%=css.list%>" data-popdown-role="body"><li>\
                ...
                <a class="<%=css.secondaryLink%>" data-role="secondary-search-more-link" href="<%- searchLink %>" target="_blank" rel="noopener noreferrer" title="<%- splunkUtils.sprintf(_("Open %s in search in new tab").t(), rawSearch) %>"></a>\
            </li></ul>\
        <% } %>\
        '
    });
