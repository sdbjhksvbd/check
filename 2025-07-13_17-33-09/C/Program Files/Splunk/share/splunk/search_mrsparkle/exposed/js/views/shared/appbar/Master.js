...
function(
    ...
    },
    {
        ...
        // This is a separate function because there used to be two (or more?!)
        // ways to generate the AppNav bar: the Python server would generate it
        // for us, rather than doing the XML parse in the browser. So this
        // function merged the fork of those code paths.
