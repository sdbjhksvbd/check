...
require.config({
    ...
    modules: [
        ...
        // At build time, a module entry for each file in the $UI_SOURCE/web/search_mrsparkle/exposed/js/pages/ directory
        // will be added here.  Unless a file of the same name exists in $UI_SOURCE/web/search_mrsparkle/exposed/js/profiles/,
