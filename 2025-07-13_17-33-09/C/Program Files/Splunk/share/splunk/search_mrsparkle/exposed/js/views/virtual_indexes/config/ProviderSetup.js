define(
    ...
    function(
        ...
        var HADOOP_3X = '$SPLUNK_HOME/bin/jars/SplunkMR-h3.jar';
        var HADOOP_3X_YARN = '$SPLUNK_HOME/bin/jars/SplunkMR-hy3.jar';
        ...
        var HUNK_THIRDPARTY_JARS_2X = '$SPLUNK_HOME/bin/jars/thirdparty/common/avro-1.7.7.jar,$SPLUNK_HOME/bin/jars/thirdparty/common/avro-mapred-1.7.7.jar,$SPLUNK_HOME/bin/jars/thirdparty/common/commons-compress-1.21.jar,$SPLUNK_HOME/bin/jars/thirdparty/common/commons-io-2.4.jar,$SPLUNK_HOME/bin/jars/thirdparty/common/libfb303-0.9.2.jar,$SPLUNK_HOME/bin/jars/thirdparty/common/parquet-hive-bundle-1.10.1.jar,$SPLUNK_HOME/bin/jars/thirdparty/common/snappy-java-1.1.1.7.jar,$SPLUNK_HOME/bin/jars/thirdparty/hive_1_2/hive-exec-1.2.1.jar,$SPLUNK_HOME/bin/jars/thirdparty/hive_1_2/hive-metastore-1.2.1.jar,$SPLUNK_HOME/bin/jars/thirdparty/hive_1_2/hive-serde-1.2.1.jar';
        var HUNK_THIRDPARTY_JARS_3X = '$SPLUNK_HOME/bin/jars/thirdparty/common/avro-1.7.7.jar,$SPLUNK_HOME/bin/jars/thirdparty/common/avro-mapred-1.7.7.jar,$SPLUNK_HOME/bin/jars/thirdparty/common/commons-compress-1.21.jar,$SPLUNK_HOME/bin/jars/thirdparty/common/commons-io-2.4.jar,$SPLUNK_HOME/bin/jars/thirdparty/common/libfb303-0.9.2.jar,$SPLUNK_HOME/bin/jars/thirdparty/common/parquet-hive-bundle-1.10.1.jar,$SPLUNK_HOME/bin/jars/thirdparty/common/snappy-java-1.1.1.7.jar,$SPLUNK_HOME/bin/jars/thirdparty/hive_3_1/hive-exec-3.1.2.jar,$SPLUNK_HOME/bin/jars/thirdparty/hive_3_1/hive-metastore-3.1.2.jar,$SPLUNK_HOME/bin/jars/thirdparty/hive_3_1/hive-serde-3.1.2.jar';
        ...
        return BaseView.extend({
                ...
                this.children.hadoopVersion = new ControlGroup({
                    ...
                    controlOptions: {
                        ...
                        items:[
                            ...
                            {label: _('Hadoop 3.x, (MRv1)').t(), value: HADOOP_3X},
                            {label: _('Hadoop 3.x, (Yarn)').t(), value: HADOOP_3X_YARN},
                        ],
                        additionalClassNames: 'view-count',
                        menuWidth: 'narrow',
                        toggleClassName: 'btn'
            ...
            _onChangeHadoopVersion: function() {
                ...
                if (this.isYarn()) {
                     ...
                     */
                    if (this.isYarn3x())
                        this.updateHunkThirdpartyJars(HUNK_THIRDPARTY_JARS_3X);
                    else
            ...
            isYarn: function() {
                return this.isYarn2x() || this.isYarn3x();
            },
            ...
            isYarn3x: function() {
                return this.model.provider.entry.content.get(HADOOP_VERSION) === HADOOP_3X_YARN;
            },
            ...
            isHadoop3x: function() {
                return this.model.provider.entry.content.get(HADOOP_VERSION) === HADOOP_3X;
            },
