define([
    ...
    'util/url',
    'views/dashboards/table/controls/CloneToStudio',
], function ($,
    _,
    ReportModel,
    TextDialog,
    ...
    cloneDashboardInStudio
        ...
        var ActionHelper = {
            ...
            handleAction: function (action, state, model, collection, deferreds) {
                switch (action) {
                    ...
                    case 'action:open-in-v2':
                        ActionHelper.openInV2(model, collection, deferreds);
                        return true;
                }
            },
            ...
            clone: function (model, collection, deferreds, cloneDashboardInStudio) {
                ...
                $.when(deferreds.roles, clone.fetch()).done(function () {
                    ...
                    var cloneDialog = new CloneDialog({
                        model: {
                            ...
                            user: model.user,
                            serverInfo: model.serverInfo,
                            cloneDashboardInStudio: cloneDashboardInStudio
                        },
                        collection: {
            ...
            openInV2: function (model, collection, deferreds) {        
                ActionHelper.clone(model, collection, deferreds, cloneDashboardInStudio);
            },
            ...
            confirmPageRefresh: function (changedAttr) {
                ...
                dialog.setText(sprintf(_("You have changed the dashboard %(changedAttr)s. To see this change, you must refresh the page.\n Would you like to refresh the page now?").t(), { changedAttr: changedAttr }));
