            ...
            render: function() {
                ...
                var that = this,
                    ...
                    apps = this.collection.apps.filter(function(app) {
                        var shouldShowInNav = app.entry.content.has('show_in_nav') && app.entry.content.get('show_in_nav');
                        var isVisible = app.entry.content.has('visible') && app.entry.content.get('visible');

                        return shouldShowInNav && isVisible;
