            ...
            faqListMonitor: function () {
                return [
                    ...
                    },
                    {
                        ...
                        answer: _('Specify a ').t() + '<a class="external" href="' + arguments[0] + '" target="_blank" rel="noopener noreferrer">' + _("wildcard").t() + '</a>' +
                        ...
                        '<a class="external" href="' + arguments[1] + '" target="_blank" rel="noopener noreferrer">' + _("Learn More").t() + '</a>'
                    }
                ];
            },
