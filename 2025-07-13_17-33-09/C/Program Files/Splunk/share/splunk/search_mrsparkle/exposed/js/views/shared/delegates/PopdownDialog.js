    ...
    return DelegateBase.extend({
        ...
        measure: function($el, offsets) {
            ...
            if (svgUtil.isSvgEl($el)) {
                ...
                measures.width = $el.outerWidth() || 0;
                measures.height = $el.outerHeight() || 0;
            }
        ...
        bodyMouseDown: function(e, $toggle) {
            ...
            var $reactPopover = $target.closest('[data-test=layer]').closest('body > *'); // this is the root of the popover that is attached to <body>
