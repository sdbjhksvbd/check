...
define([
    ...
    var popdown =  DelegateBase.extend({
        ...
        hearShow: function($toggle) {
            ...
            this.$activeToggle.attr('aria-expanded', true);
        },
        ...
        keydownToggle: function(e) {
            ...
            e.originalEvent.isPopdownShown = this.children.delegate ? this.children.delegate.isShown() : false;
        },
        hearHide: function($toggle) {
            ...
            this.$activeToggle.attr('aria-expanded', false);
        },
