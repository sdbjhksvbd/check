    ...
    return BaseView.extend({
        ...
        _buildLayout: function(options) {
            ...
            this.children.switchTSDIXReduction = new ControlGroup({
                ...
                help:_('Warning: Do not enable reduction without understanding the full implications. It is extremely difficult to rebuild reduced buckets. <a href="'+ docRoute +'" class="external" target="_blank" rel="noopener noreferrer" + title="' + _("Splunk help").t() + '">Learn More</a>').t()
            });
