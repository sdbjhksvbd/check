    ...
    function($, _, Model, SplunkDsBaseCollection) {
        return SplunkDsBaseCollection.extend({
            ...
            initialize: function(options) {
                ...
                var cloudEndpoint = options.isSingleInstanceCloud ? onPremEndpoint : 'cluster_blaster_transforms/sh_metric_transforms_manager';
            ...
            getAttributes: function(){
                ...
                return {
                    ...
                    'whitelist_dimensions' : model.entry.content.get('METRIC-SCHEMA-WHITELIST-DIMS')
                };
            }
        });
    }
