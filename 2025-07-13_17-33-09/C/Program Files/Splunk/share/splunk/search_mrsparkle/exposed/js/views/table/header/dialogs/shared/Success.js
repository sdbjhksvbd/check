    ...
    function(
        ...
        return Base.extend({
            ...
            render: function() {
                ...
                this.$(Modal.FOOTER_SELECTOR).append('<a href="' + routeToExplore + '" class="btn explore-dataset btn-primary pull-right">' + _('View Table').t() + '</a>');
                this.$(Modal.FOOTER_SELECTOR).append('<a href="' + routeToDatasets + '" class="btn continue-editing pull-right">' + _('View Listings').t() + '</a>');
                this.$(Modal.FOOTER_SELECTOR).append('<a href="#" class="btn pull-left done" data-dismiss="modal">' + _('Close').t() + '</a>');
