        ...
        return Base.extend({
            ...
            initialize: function() {
                ...
                this.children.emailSubject = new ControlGroup({
                    ...
                    label: _('Subject').t(),
                    help: splunkUtil.sprintf(_('The email subject, recipients and message can include tokens that insert text based on the results of the search. %s').t(), ' <a class="help-link" href="' + configTokenHelpLink + '" target="_blank" rel="noopener noreferrer" title="' + _("Splunk help").t() +'">' + _("Learn More").t() + ' <i class="icon-external"></i></a>')
                });
