define(function(require, exports, module) {
    ...
    require("css-loader!../css/messages.css");
...
<div class="splunk-message-container <%- compact ? \'compact\' : \'\' %>">\
    ...
    var Messages = {
        ...
        render: function(info, elem) {
            ...
            if (elem.jquery) {
                elem.html(_.template(this.messageTemplate, info));
            } else {
                elem.innerHTML = _.template(this.messageTemplate, info);
            }
        },
