    ...
    function(module,
        ...
        return BaseDashboardView.extend({
            ...
            initialize: function(options) {
                ...
                this.listenTo(
                    this.model.state,
                    'change:mode change:dirty change:isSourceVersionSpecified',
                    this._updateState
                );
            },
            events: {
                ...
                'click a.edit-save-as:not(.disabled)': function(e) {
                    e.preventDefault();
            ...
            _updateState: function(state) {
                ...
                this.$('.edit-done')[
                    state.get('dirty') && state.get('isSourceVersionSpecified') ? 'removeClass' : 'addClass'
                    ]('disabled');
                this.$('.edit-save-as')[state.get('isSourceVersionSpecified') ? 'removeClass' : 'addClass']('disabled');
