            ...
            events: {
                'click .search-button > .btn': function(e) {
                    ...
                    splunkUtils.trackPageInteraction(
                        ...
                        'Click search button',
                        {
                            earliestTime: this.model.state.get('dispatch.earliest_time'),
                            latestTime: this.model.state.get('dispatch.latest_time'),
                            searchMode: this.model.state.get('display.page.search.mode'),
                        }
                    );
                }
            },
