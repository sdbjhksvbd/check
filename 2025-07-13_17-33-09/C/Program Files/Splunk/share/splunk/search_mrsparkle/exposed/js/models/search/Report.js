    ...
    function($, _, SavedSearch, Viewstate, Cron, JobsCollection, HistoriesCollection, time_utils, splunkd_utils, general_utils, splunkUtil, i18n, route, URI_CONSTANTS, math_utils) {
        ...
        var ReportModel = SavedSearch.extend({
            ...
            parse: function(response) {
                ...
                this.entry.content.set('type', this.getType());
            ...
            stripAlertAttributes: function(options) {
                this.entry.content.unset("alert.suppress");
                this.entry.content.unset("alert.suppress.period");
                this.entry.content.unset("alert.suppress.fields");
                this.entry.content.unset("alert.digest_mode");
                this.entry.content.unset("alert.track");
            ...
            getExportedURLParams: function(viewRouteData, data, timeParams) {
                if (viewRouteData && viewRouteData.route && viewRouteData.route().indexOf(URI_CONSTANTS.PAGES.ANALYTICS_WORKSPACE) >= 0) {
