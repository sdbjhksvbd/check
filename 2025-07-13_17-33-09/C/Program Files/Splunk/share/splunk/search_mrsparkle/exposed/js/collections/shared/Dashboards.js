    ...
    function ($, _, Backbone, ViewsCollection, DashboardModel) {
        return ViewsCollection.extend({
            ...
            sync: function (method, collection, options) {
                ...
                // UDF dashboard rootNode is <dashboard version="2"> which we support now if dashboards app is installed
                var baseSearch = '(isDashboard=1 AND (rootNode="dashboard" OR rootNode="form" OR rootNode="view" OR rootNode="html") AND isVisible=1)';
