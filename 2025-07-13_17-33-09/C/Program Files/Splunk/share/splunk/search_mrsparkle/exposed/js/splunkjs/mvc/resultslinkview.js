define(function(require, exports, module) {
    ...
    var ResultsLinkView = BaseSplunkView.extend(/** @lends splunkjs.mvc.ResultsLinkView.prototype */{
        ...
        template: '\
            <a href="#" class="search-button btn-pill" title="<%- options[\'link.openSearch.text\'] || _(\'Open in Search\').t() %>">\
                <i class="icon-search"></i>\
                <span class="hide-text"><%- options[\'link.openSearch.text\'] || openLabel %></span>\
            </a>\
            <% if (showExportResultsButton) { %>\
                <a href="#" class="export-button btn-pill" title="<%- _(\'Export - You can only export results for completed jobs.\').t() %>">\
                    <i class="icon-export"></i>\
                    <span class="hide-text"><%- _("Export").t() %></span>\
                </a>\
            <% } %>\
            <a href="#" class="inspect-button btn-pill" title="<%- _(\'Inspect\').t() %>">\
                <i class="icon-info"></i>\
                <span class="hide-text"><%- _("Inspect").t() %></span>\
            </a><a href="#" class="refresh-button btn-pill" title="<%- _(\'Refresh\').t() %>">\
        ...
        pivotTemplate: '\
            <a href="#" class="pivot-button btn-pill" title="<%- _(\'Open in Pivot\').t() %>">\
                <i class="icon-pivot"></i>\
                <span class="hide-text"><%- _("Open in Pivot").t() %></span>\
            </a>\
            <% if (showExportResultsButton) { %>\
                <a href="#" class="export-button btn-pill" title="<%- _(\'Export\').t() %>">\
                    <i class="icon-export"></i>\
                    <span class="hide-text"><%- _("Export").t() %></span>\
                </a>\
            <% } %>\
