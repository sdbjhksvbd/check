define(function(require, exports, module) {
    ...
    var $poly = require('util/jquery_polyfills');
            ...
            this.listenTo(this._mockController, 'all', function(event) {
                switch (event) {
                    ...
                    case 'action:edit-permission':
                        ...
                        document.body.appendChild(this.children.permissionsDialog.render().el);
                        ...
                        clone.fetch({
                            success: function() {
                                ...
                                var cloneDialog = this.children.cloneDialog = new CloneDialog({
                                    model: {
                                        dashboard: clone,
                                        acl: new ACLReadOnlyModel($poly.deepExtend({}, this.model.dashboard.entry.acl.toJSON())),
                                        application: this.model.application,
                                ...
                                document.body.appendChild(cloneDialog.render().el);
                                cloneDialog.show();
                            }.bind(this)
                        });
                        break;
                    case 'action:delete':
                        ...
                        dialog.settings.set("titleLabel", _("Delete Dashboard").t());
