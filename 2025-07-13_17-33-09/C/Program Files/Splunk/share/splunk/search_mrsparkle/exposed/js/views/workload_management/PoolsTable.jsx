            ...
            <Table stripeRows>
                <Table.Head>
                    ...
                    <Table.HeadCell align="center">
                        {_('CPU Weight').t()}&nbsp;
                        <Tooltip content="The total CPU weight available to the pool." />
                    </Table.HeadCell>
                    <Table.HeadCell align="center">
                        {_('Allocated CPU %').t()}&nbsp;
                        <Tooltip content="The percentage of available CPU allocated to the pool." />
                    </Table.HeadCell>
                    <Table.HeadCell align="center">
                        {_('Memory Limit %').t()}&nbsp;
                        <Tooltip content="The maximum percentage of Memory available to the pool." />
                    </Table.HeadCell>
                    <Table.HeadCell align="center">
                        {_('Allocated Memory Limit %').t()}&nbsp;
                        <Tooltip content="The percentage of available Memory allocated to the pool." />
                    </Table.HeadCell>
