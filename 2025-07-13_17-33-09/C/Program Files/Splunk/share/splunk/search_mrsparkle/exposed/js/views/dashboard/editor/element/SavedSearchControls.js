    ...
    var SavedSearchControls = ElementControls.extend({
        ...
        reportDetailsTemplate: '\
            ...
            <ul class="reportDetails">\
                <li><a target="_blank" rel="noopener noreferrer" href="<%- viewReportLink %>" class="viewSearchReport"><%- _("View").t() %></a></li>\
                <li><a target="_blank" rel="noopener noreferrer" href="<%- editReportLink %>" class="openSearchReport"><%- editReportLabel %></a></li>\
