    ...
    function(
        ...
        return BaseView.extend({
            ...
            */
            ...
            render: function() {
                ...
                $.when(this.tableASTFetchDeferred).then(function() {
                    ...
                    if (datasetPayloads && datasetPayloads.length) {
                        this.$('.non-fields').append(_.template(this.extendsTemplate));
            ...
            template: '\
                <div class="half non-fields">\
                    <dt class="type"><%- _("Type").t() %></dt>\
                ...
                <div class=" half fields"><dt><%- _("Fields").t() %></dt>\
                    <% _(fields.split(",")).each(function(field) { %>\
                        <dd class="fields" data-test-name="field">\
                            <%- field %>\
                        </dd>\
                    <% }); %>\
                </div>\
