        ...
        return Base.extend({
            ...
            initialize: function() {
                ...
                this.children.email = new ControlGroup({
                    ...
                    help: splunkUtil.sprintf(_('Email must be configured in System&nbsp;Settings > Alert&nbsp;Email&nbsp;Settings. %s').t(), ' <a href="' + configEmailHelpLink + '" target="_blank" rel="noopener noreferrer">' + _("Learn More").t() + ' <i class="icon-external"></i></a>')
                });
