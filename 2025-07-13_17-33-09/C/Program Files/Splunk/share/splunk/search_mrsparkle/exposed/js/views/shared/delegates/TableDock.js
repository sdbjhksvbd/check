...
define(['jquery', 'underscore', 'views/shared/delegates/DetachedTableHeader'], function($, _, DetachedTableHeader) {
    ...
    return DetachedTableHeader.extend({
        ...
        updateHeaders: function() {
            ...
            // SPL-202007: Prevents duplicated cycle of tab navigations since TableDock is cloned from TableHead template with default tabindex=0
            this.$header.find('th').attr('tabindex', -1); 
