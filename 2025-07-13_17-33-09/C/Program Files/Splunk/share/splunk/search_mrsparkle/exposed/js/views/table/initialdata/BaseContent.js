    ...
    function(
        ...
        return BaseView.extend({
            ...
            events: {
                ...
                'click .initial-data-back': function(e) {
                    e.preventDefault();
                    // from IndexesAndSourcetypesContent.js
            ...
            renderFieldsPicker: function() {
                ...
                this.children.fieldsPicker.activate({ deep: true }).render().insertBefore(this.$('.button-container'));
            },
            ...
            appendButtonRow: function() {
                var doneButton = '<div class="button-container"><a href="#" class="btn initial-data-back">' + _('Back').t() +
                    '</a><a href="#" class="btn btn-primary initial-data-done">' + _('Start Editing').t() + '</a></div>';
                $(doneButton).appendTo(this.$el);
            },

            appendDoneButton: function() {
                var doneButton = '<div class="button-container"><a href="#" class="btn btn-primary initial-data-done">' + _('Done').t() + '</a></div>';
                $(doneButton).appendTo(this.$el);
            },
