    ...
    function(_, module, classicurlModel, Base, Count, Controls, Buttons, SearchMode, AutoPause, SamplingMode, WorkloadPoolSelect, ProgressBar, route, splunkwindow, splunkUtil, splunkd_utils, css) {
        return Base.extend({
            ...
            events: {
                ...
                'click div.job-menu': function (e) {
                    if (this.$('div.job-menu a').hasClass('active')) { //send only if click operation is performed to open dropdown
                        splunkUtil.trackPageInteraction(this.model.application.get('app'), 'Click Job Settings Dropdown');
                    }
                }
            },
            ...
            template: '\
                <div class="jobstatus-grouping">\
                    <div class="jobstatus-status-grouping"></div>\
