define([
    ...
    return Backbone.Router.extend(/** @lends routers.Base.prototype */{
        ...
        initialize: function(options) {
            ...
            this.model.globalBanner = options.model.globalBanner || new GlobalBannerModel();
            ...
            this.deferreds.globalBanner = options.deferreds.globalBanner || $.Deferred();
            ...
            // Capture true HTTP resp of model/collection bootstrap data to pass from core shell
            // app to core remote apps. Interim solution to decouple depdency with backbone.
            this.baseHttpResponses = {};
        ...
        page: function(locale, app, page) {
            ...
            if (this.enablePageView && !this.pageView) {
                this.$whenPageViewDependencies().then(function(){
                    ...
                    // Set pageViewSingleton with PageView
                    pageViewSingleton.setPageView(this.pageView);
                    ...
                    if (appNavPartialData) {
                        ...
                        this.model.appNav.fetch({
                            ...
                            success: function(model, response) {
                                this.baseHttpResponses.appNav = response;
                                this.deferreds.appNav.resolve();
                            }.bind(this),
                ...
                if (this.fetchAppLocals || this.fetchVisualizations) {
                    ...
                    this.collection.appLocals.fetch({
                        ...
                        success: function(collection, response) {
                            this.baseHttpResponses.appLocals = response;
        ...
        bootstrapTour :function() {
            if (this.deferreds.tour.state() !== 'resolved') {
                this.collection.tours.fetch({
                    ...
                    success: function(collection, response) {
                        this.baseHttpResponses.tour = response;
                        this.setTourModel();
                    }.bind(this),
                    error: function(collection, response) {
                        this.baseHttpResponses.tour = response;
                ...
                if (this.fetchAppLocal && (app !== 'system')) {
                    ...
                    if (appLocalPartialData) {
                        ...
                        this.model.appLocal.fetch({
                            ...
                            success: function(model, response) {
                                this.baseHttpResponses.appLocal = response;
                                this.deferreds.appLocal.resolve();
                            }.bind(this),
                            error: function(model, response) {
                                this.baseHttpResponses.appLocal = response;
        ...
        bootstrapGlobalBanner: function() {
            if (this.deferreds.globalBanner.state() !== 'resolved') {
                this.model.globalBanner.fetch({
                    success: function(model, response) {
                        this.baseHttpResponses.globalBanner = response;
                        this.deferreds.globalBanner.resolve();
                    }.bind(this),
                    error: function(model, response) {
                        this.baseHttpResponses.globalBanner = response;
                ...
                if (this.fetchUser || this.fetchServerInfo) {
                    ...
                    if (serverInfoPartialData && !fromLogin) {
                        ...
                        this.model.serverInfo.fetch({
                            success: function(model, response) {
                                this.baseHttpResponses.serverInfo = response;
                                this.deferreds.serverInfo.resolve();
                            }.bind(this),
                            error: function(model, response) {
                                this.baseHttpResponses.serverInfo = response;
        ...
        bootstrapUserPref: function() {
            if (this.deferreds.userPref.state() !== 'resolved') {
                this.model.userPref.fetch({
                    success: function(model, response) {
                        this.baseHttpResponses.userPref = response;
        ...
        bootstrapWebConf: function() {
            if (this.deferreds.web.state() !== 'resolved') {
                this.model.web.fetch({
                    success: function(model, response) {
                        this.baseHttpResponses.web = response;
                    ...
                    this.model.user.fetch({
                        ...
                        success: function(model, response) {
                            $.when(this.deferreds.serverInfo).then(function() {
                                this.baseHttpResponses.user = response;
                ...
                if (this.fetchManagers) {
                    this.collection.managers.fetch({
                        ...
                        success: function(collection, response, options) {
                            this.baseHttpResponses.managers = response;
                ...
                if (vizDfd.state() !== 'resolved') {
                    ...
                    $.when(this.deferreds.appLocals).done(function() {
                        this.collection.visualizations.fetch({
                            ...
                            success: function(collection, response, options) {
                                this.baseHttpResponses.visualizations = response;
                                vizDfd.resolve();
                            }.bind(this),
                            error: function(collection, response, options) {
                                this.baseHttpResponses.visualizations = response;
