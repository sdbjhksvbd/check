            ...
            <div class="select-sample-header">\
                <div class="instruction">\
                    ...
                    <span class="instruction-text">\
                        ...
                        <a href="<%- fieldsHelpHref %>" class="external" target="_blank" rel="noopener noreferrer"><%- _("Learn more").t() %></a>\
            ...
            <div class="select-method-header">\
                <div class="instruction">\
                    ...
                    <span class="instruction-text">\
                        ...
                        <a href="<%- ifxHelpHref %>" class="external" target="_blank" rel="noopener noreferrer"><%- _("Learn more").t() %></a>\
                    </span>\
                    <div class="manual-mode-button-container"><a href="#" class="manual-mode-button"><%- _("I prefer to write the regular expression myself").t() %> <i class="icon-chevron-right"></i></a></div>\
                </div>\
                <% if (type === "sourcetype") { %>\
            ...
            <div class="select-fields-header">\
                <div class="instruction">\
                    ...
                    <span class="instruction-text">\
                        ...
                        <a href="<%- delimRenameHelp %>" class="external" target="_blank" rel="noopener noreferrer"><%- _("Learn more").t() %></a>\
                    </span>\
