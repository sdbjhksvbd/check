...
function(
    ...
    return PopTartView.extend({
        ...
        render: function() {
            this.el.innerHTML = '';
            this.$el.append('<span class="visuallyhidden">' + _("Press escape to exit").t() + '</span>');
        ...
        <ul class="<%=css.list%>" data-popdown-role="body"><li>\
            ...
            <a class="<%=css.secondaryLink%>" data-role="secondary-search-more-link" href="<%- searchLink %>" target="_blank" rel="noopener noreferrer" aria-label="<%- splunkUtils.sprintf(_("Open %s in search in new window").t(), rawSearch) %>">\
            </a>\
        </li></ul>\
        '
    });
