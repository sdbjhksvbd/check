    ...
    return BaseView.extend({
        ...
        setAppIcon: function(appId) {
            var iconSrc = route.appIcon(
                    ...
                    appId);
            this.$('[data-role=icon]').append('<img src="' + iconSrc + '" alt="' + _('App icon').t() + '" />');
        },
        ...
        render: function() {
            ...
            var html = this.compiledTemplate({
                msg: HtmlCleaner.clean(formattedMsg),
                msgLevel: msgLevel,
                msgTime: msgTime || '',
        ...
        template: '\
                ...
                <% if (msgHelp) { %>\
                    <a href="<%= msgHelp %>" class="message-help external" target="_blank" rel="noopener noreferrer"><%- _("Learn more.").t() %></a>\
                <% } %>\
                </span>\
