    ...
    function(
        ...
        return JobsCollection.extend({
            ...
            fetchNonAutoSummaryJobs: function(options) {
                ...
                var omit_autosummary = '(NOT scheduler__nobody__system__SMA* AND NOT (label=CASE(*_ACCELERATE_*) AND provenance=scheduler) AND NOT CASE(_AUTOSUMMARY_) AND NOT "|*summarize*action=")',
                    filters = {};
