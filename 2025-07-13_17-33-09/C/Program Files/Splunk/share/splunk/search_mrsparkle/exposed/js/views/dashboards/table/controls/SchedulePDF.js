    ...
    function (module,
        ...
        return Modal.extend({
            ...
            initialize: function () {
                ...
                pdfUtils.getEmailAlertSettings().done(function (emailSettings) {
                    var paperSize = emailSettings.entry.content.get('reportPaperSize');
                    var paperOrientation = emailSettings.entry.content.get('reportPaperOrientation');
                    if (paperSize) {
                        this.model.inmem.set('action.email.papersize', paperSize);
                    }
                    if (paperOrientation) {
                        this.model.inmem.set('action.email.paperorientation', paperOrientation);
                    }
                }.bind(this));
