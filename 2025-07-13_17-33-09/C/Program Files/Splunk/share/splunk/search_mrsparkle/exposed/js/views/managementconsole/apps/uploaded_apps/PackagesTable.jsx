...
const STRINGS = {
    ...
    ACK_MODAL_DEFAULT_TITLE: _('Acknowledge and Install').t(),
};
...
class PackagesTable extends Component {
    ...
    render() {
        const acknowledgementModalProps = {
            open: this.props.acknowledgementModalOpen,
            packageId: this.props.packageId,
            handleRequestClose: this.props.onAcknowledgementModalClose,
            onInstallPackage: this.props.onInstallPackage,
            vettingWarningCount: this.props.vettingWarningCount,
            viewReportLink: this.props.viewReportLink,
            title: this.props.acknowledgementModalTitle || STRINGS.ACK_MODAL_DEFAULT_TITLE,
        };

        const installAppLinkProps = {
            action: ACTIONS.INSTALL,
            actionDialogOpen: this.props.actionDialogOpen,
            onActionDialogOpen: this.props.privateAppGlobal ?
                this.props.onAcknowledgementModalOpen : this.props.onInstallPackageOpen,
        ...
        return (
            <div data-test="UploadedApps-PackagesTable">
                ...
                <AcknowledgementModal {...acknowledgementModalProps} />
...
PackagesTable.propTypes = {
    ...
    viewReportLink: PropTypes.string,
};
