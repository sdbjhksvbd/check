        ...
        return Modal.extend({
            ...
            events: $.extend({}, Modal.prototype.events, {
                'click .btn-primary': function(e) {
                    ...
                    if (_.isEmpty(this.model.entity.entry.content.get('password')) && !this.model.entity.entry.content.get('force-change-pass')) {
            ...
            initialize: function(options) {
                ...
                // Set fcpBoolFlag on editUser to null. This ensures the toggle is not selected by default and
                // will only be automatically selected once when the user enters a new password onEdit. Re: SPL-155630
                var fcpBoolFlag = (options.isNew || options.isClone) ? true : null;
                ...
                this.children.forceChangePass = new ControlGroup({
                    ...
                    label: options.isNew ? _('Require password change on first login').t() : _('Require password change on next login').t()
                });
