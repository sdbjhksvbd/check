define(
    ...
    function($, _, module, SearchBarModel, UserModel, Base, AdvancedEditorSearchField, TextAreaSearchField, SearchAssistant, splunkUtils, css, rum) {
        return Base.extend({
            moduleId: module.id,
            ...
            startListening: function() {
                ...
                this.listenTo(this, 'addedToDocument', this.markHeroElement);
            },
            ...
            markHeroElement: function() {
                rum.mark('Search Input - Time to Interactive', { timeout: 50 });
            }
        });
    }
);
