        ...
        return BaseController.extend({
            ...
            openAccelerateDialogHandler: function(modelName) {
                this.fetchEditableDataModel(modelName).then(_.bind(function() {
                    ...
                    if (this.dataModelToEdit.getSourceGUID()) {
                        // Don't allow acceleration if a a source guid is specified
                        this.children.warnSourceGUIDDialog = new TextDialog({id: "modal_sourceGUID"});
                       	this.children.warnSourceGUIDDialog.settings.set("primaryButtonLabel", undefined);
                        this.children.warnSourceGUIDDialog.settings.set("cancelButtonLabel",undefined);
                        this.children.warnSourceGUIDDialog.on("hidden", this.destroyWarnSourceGUIDDialogHandler, this);
                        this.children.warnSourceGUIDDialog.settings.set("titleLabel",_("Acceleration Warning").t());
                        this.children.warnSourceGUIDDialog.setText(
                            _("Datamodels with a set source GUID cannot generate their own summaries. Remove the setting to " +
                                "alter acceleration.").t());
                        $("body").append(this.children.warnSourceGUIDDialog.render().el);
                       this.children.warnSourceGUIDDialog.show();
                        ...
                        this.children.warnAccelerationDialog.setText(
                            _("You can only accelerate data models that include at least one event-based dataset or " +
                                "one search-based dataset that does not use reporting commands.").t());
            ...
            destroyWarnSourceGUIDDialogHandler: function() {
                this.children.warnsourceGUIDDialog.remove();
                delete this.children.warnSourceGUIDDialog;
            },
