    ...
    function(module,
        ...
        return BaseDashboardView.extend(_.extend({}, TokenDependenciesMixin, SearchManagerMixin, EventManagerMixin, {
            ...
            _normalizeLabel: function() {
                ...
                // SPL-196368 Add labelledBy attribute to the view settings
                this.settings.set('labelledBy', this.inputId + '-label');
            },
            ...
            _renderLabel: function() {
                ...
                if (label) {
                    ...
                    this.$label.attr('id', this.inputId + '-label');
                } else {
                    this.$label.html('&nbsp;');
                }
            },
            _renderInput: function() {
                ...
                // If we added custom aria-labelledBy attribute to a component, we need to make
                // sure the component reads its own label as well as the custom label
                this.children.input.$el.find("[aria-labelledby*='" + this.inputId + "-label']").each(function (i){
                    if ($(this).attr('id')) {
                        $(this).attr('aria-labelledBy', $(this).attr('aria-labelledBy') + ' ' + $(this).attr('id'));
                    }
                });
