...
define([
    ...
    var PivotElementsDisplay = BaseView.extend({
        ...
        rootTemplate: '\
            \
            <a class="table-help-link" href="<%- tableHelpHref %>" target="_blank" rel="noopener noreferrer"><span><%- _("Documentation").t() %></span><i class="icon-external icon-no-underline"></i></a>\
