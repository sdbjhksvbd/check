    ...
    function(
        ...
        return Base.extend({
            ...
            two_step_intro_template: '\
                ...
                <p></p>\
                <p name="comment">\
                    <i><%= _("Tip: Add comment text to your search string by wrapping it in triple backticks. ").t() %></i>\
            ...
            command_template: '\
                <div class="intro-and-command-header">\
                    ...
                    <a class="external" href="<%= commandHelpLink %>" target="_blank" rel="noopener noreferrer" title="<%- _(\"Splunk Help\").t() %>"><%- _("Help").t() %></a>\
