define(function(require, exports, module) {
     ...
     * works best with the <a href="http://docs.splunk.com/Documentation/Splunk/latest/SearchReference/Geostats" target="_blank" rel="noopener noreferrer">**geostats**</a> search command, which provides clustering and spatial statistics in the Splunk search language.
     *
     ...
     * <a href="http://docs.splunk.com/Documentation/Splunk/latest/Viz/PanelreferenceforSimplifiedXML#map" target="_blank" rel="noopener noreferrer">map</a>
     * and <a href="http://docs.splunk.com/Documentation/Splunk/latest/Viz/PanelreferenceforSimplifiedXML#Choropleth_map_options" target="_blank" rel="noopener noreferrer">Choropleth map options</a>
    ...
    var SplunkMapView = BaseVisualizationView.extend(/** @lends splunkjs.mvc.SplunkMapView.prototype */{
        ...
        message: function(type) {
            var isTrellised = GeneralUtils.normalizeBoolean(this.model.get('display.visualizations.trellis.enabled'), { 'default': false })
                && this.model.get('display.visualizations.mapping.type') === 'choropleth';

            // For non-trellised maps, the waiting and no results states should show an empty map.
            if (!isTrellised && (type === 'waiting' || type === 'no-results')) {
                this.hideMessages();
                return;
            }
