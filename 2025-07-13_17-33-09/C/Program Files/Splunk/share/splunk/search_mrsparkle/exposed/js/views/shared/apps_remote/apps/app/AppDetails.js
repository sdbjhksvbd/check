        ...
        return BaseView.extend({
            ...
            template:
                       '<span class="app-detail" title="Category"><span class="categories-placeholder"></span></span>' +
                        ...
                        '<span class="app-detail" title="Website"><a href="https://apps.splunk.com/app/<%- model.get("uid") %>" target="_blank" rel="noopener noreferrer"><%- _("View on Splunkbase").t() %></a></span>'
        });
    });
