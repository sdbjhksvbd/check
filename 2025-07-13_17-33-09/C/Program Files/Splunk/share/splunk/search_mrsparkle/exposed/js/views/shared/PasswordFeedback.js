    ...
    function($, _, splunkutil, Backbone, Base, route, module, ControlGroup, css) {
        return Base.extend({
            ...
            onPasswordMatch: function() {
                $(".mismatch-msg").hide();
                // 'force-change-pass' is set to null by default in editUser modal. Below will set 'force-change-pass' to true
                // once b/c subsequent toggles of 'force-change-pass' will set it to false. Re: SPL-155630
                if (this.model.entity.entry.content.get('force-change-pass') === null) {
                    this.model.entity.entry.content.set('force-change-pass', true);
                }
            },
