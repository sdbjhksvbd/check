...
function(
    ...
    return HelpMenu.extend({
        ...
        events: Object.assign({}, HelpMenu.prototype.events, {
        ...
        renderToursModal: function() {
            ...
            document.body.appendChild(this.children.toursModal.render().el);
        ...
        renderProductTour: function() {
            ...
            $.when(tourDfd).then(function() {
                ...
                document.body.appendChild(this.children.imageTour.render().el);
