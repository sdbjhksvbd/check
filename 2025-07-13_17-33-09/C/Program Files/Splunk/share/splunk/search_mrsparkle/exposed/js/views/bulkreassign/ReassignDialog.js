...
define([
    ...
    return Modal.extend({
        ...
        bodyTemplate: '<div class="security-warning"><div class="alert alert-warning"><i class="icon-alert"></i><span class="message"></span> <a href="<%- learnMoreLink %>" target="_blank" rel="noopener noreferrer" class="external"><%= _("Learn more").t() %></a></div></div></div><div class="flash-message-placeholder"></div><div class="owner-form form-horizontal"></div><div class="bulk-progress"></div>'
    });
});
