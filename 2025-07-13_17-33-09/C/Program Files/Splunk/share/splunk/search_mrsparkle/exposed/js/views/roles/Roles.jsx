...
import ViewIndexesModal from './modals/ViewIndexes';
import { MAX_FILTER_LENGTH } from './Utils';

const DEFAULT_USERS = ['admin', 'user', 'power', 'can_delete', 'splunk-system-role'];
...
class RolesManager extends Main {
    ...
    static defaultProps = {
        ...
        customActions: [
            ...
            {
                key: 'viewIndexes',
                label: _('View Indexes'),
                ModalToOpen: ViewIndexesModal,
            },
            {
                key: 'delete_role',
                label: _('Delete'),
    ...
    componentDidMount() {
        ...
        rum.mark('Roles Managment Page - First meaningful paint', { timeout: 0 });
    }
}
