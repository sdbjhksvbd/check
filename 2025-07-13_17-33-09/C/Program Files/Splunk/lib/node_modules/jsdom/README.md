...
Note that as of our 4.0.0 release, jsdom no longer works with Node.jsâ„¢, and instead requires io.js. You are still welcome to install a release in [the 3.x series](https://github.com/tmpvar/jsdom/tree/3.x) if you use Node.jsâ„¢.
