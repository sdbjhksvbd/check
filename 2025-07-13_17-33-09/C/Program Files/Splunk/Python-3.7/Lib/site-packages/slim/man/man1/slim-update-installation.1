...
.
.TH "UPDATE\-INSTALLATION" "1" "May 2020" "Splunk, Inc." "Splunk Packaging Toolkit"
.
.SH "NAME"
...
.
.P
\fB\-d\fR <specification> [<specification> \.\.\.], \fB\-\-deployment\-packages=\fR<specification> [<specification> \.\.\.] Specify a set of deployment packages by name, workload, andâ€”for forwarder workloadsâ€”input groups\. A deployment specification is represented by a JSON object:
.
.IP "" 4
.
.nf
