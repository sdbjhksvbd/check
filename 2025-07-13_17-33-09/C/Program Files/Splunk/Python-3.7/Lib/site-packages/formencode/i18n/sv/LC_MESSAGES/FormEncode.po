...
msgstr "Ange ett vÃ¤rde."

#: formencode/api.py:402
#, python-format
msgid "The input must be a string (not a %(type)s: %(value)r)"
msgstr "Inmatningen mÃ¥ste bestÃ¥ av en strÃ¤ng (inte %(type)s: %(value)r)"

#: formencode/api.py:403
msgid "The input must be a string (not None)"
msgstr "Inmatningen mÃ¥ste bestÃ¥ av en strÃ¤ng (ej tom)"
...
msgstr "Ange ett giltigt postnummer (se BS 7666 fÃ¶r format)"

#: formencode/national.py:340
msgid "That country is not listed in ISO 3166"
msgstr "Det landet finns inte med i ISO 3166-listan."

#: formencode/national.py:395
msgid "Given postal code does not match the country's format."
msgstr "Det angivna postnumret Ã¶verensstÃ¤mmer inte med landsformatet."
...
msgstr "Det sprÃ¥ket inte Ã¤r upptaget i ISO 639"

#: formencode/schema.py:68
#, python-format
msgid "The input field %(name)s was not expected."
msgstr "InmatningsfÃ¤ltet %(namn) var inte fÃ¶rvÃ¤ntat."

#: formencode/schema.py:69
msgid "Missing value"
msgstr "Saknat vÃ¤rde"
...
msgstr "Datumet mÃ¥ste ligga efter %(date)s"

#: formencode/validators.py:797
#, python-format
msgid "Date must be before %(date)s"
msgstr "Datumet mÃ¥ste ligga fÃ¶re %(date)s"
...
msgstr "Datumet mÃ¥ste ligga i framtiden"
...
msgstr "Ange ett vÃ¤rde som inte Ã¶verstiger %(max)i tecken"

#: formencode/validators.py:1037
#, python-format
msgid "Enter a value %(min)i characters long or more"
msgstr "Ange ett vÃ¤rde som Ã¤r %(min)i tecken lÃ¥ngt"
...
msgstr "En e-postadress fÃ¥r bara innehÃ¥lla ett enda @"
...
msgstr "Du mÃ¥ste ange ett komplett domÃ¤nnamn (som %(domÃ¤n)er.com"
...
msgstr "Du mÃ¥ste ange ett vÃ¤rde fÃ¶r %s"
...
msgstr "Det numret Ã¤r inte giltigt fÃ¶r den korttypen"

#: formencode/validators.py:2772
#, python-format
msgid "The field %(key)s is missing"
msgstr "FÃ¤ltet %(key)s saknas"
...
msgstr "Ange nummer fÃ¶r sÃ¤kerhetskoder"
