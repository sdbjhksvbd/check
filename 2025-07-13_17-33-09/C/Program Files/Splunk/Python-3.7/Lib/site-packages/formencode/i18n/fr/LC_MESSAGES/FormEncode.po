...
# StÃ©phane Raimbault <stephane.raimbault@gmail.com>, 2008
msgid ""
msgstr ""
...
"Last-Translator: StÃ©phane Raimbault <stephane.raimbault@gmail.com>\n"
...
msgstr "La valeur saisie doit Ãªtre une chaÃ®ne (et non une %(type)sÂ : %(value)r)"

#: formencode/api.py:396
msgid "The input must be a string (not None)"
msgstr "La valeur saisie doit Ãªtre une chaÃ®ne (et non Â«Â NoneÂ Â»)"
...
"Ã©ventuellement sous la forme Â«Â ext.####Â Â»"
...
msgstr "Cette langue n'est pas mentionnÃ©e dans la norme ISO 639"

#: formencode/schema.py:63
#, python-format
msgid "The input field %(name)s was not expected."
msgstr "Le champ de saisie Â«Â %(name)sÂ Â» n'Ã©tait pas attendu."
...
msgstr "La valeur saisie doit Ãªtre un dictionnaire (et non %(type)s: %(value)r)"
...
msgstr "%(object)r doit Ãªtre d'un des types %(typeList)s"

#: formencode/validators.py:150
#, python-format
msgid "%(object)r must be of the type %(type)s"
msgstr "%(object)r doit Ãªtre de type %(type)s"

#: formencode/validators.py:330
#, python-format
msgid "Enter a value less than %(maxLength)i characters long"
msgstr ""
"Saisissez une chaÃ®ne dont la longueur est infÃ©rieure Ã  %(maxLength)i "
"caractÃ¨res"
...
msgstr "Saisissez une valeur d'au moins %(minLength)i caractÃ¨res"
...
msgstr "Saisissez seulement des lettres, nombres ou Â«Â _Â Â» (underscore)"
...
msgstr "La valeur doit Ãªtre une des suivantesÂ : %(items)s (et non %(value)r)"
...
msgstr "Saisissez une valeur parmiÂ : %(items)s"
...
"Choississez l'une des suivantesÂ : %(items)s"

#: formencode/validators.py:705
msgid "Must be an integer index"
msgstr "L'index doit Ãªtre un entier"
...
msgstr "L'Ã©lÃ©ment %(value)s n'a pas Ã©tÃ© trouvÃ© dans la liste"

#: formencode/validators.py:777
#, python-format
msgid "Date must be after %(date)s"
msgstr "La date doit se situer aprÃ¨s %(date)s"
...
msgstr "Saisissez une valeur dont la longueur est infÃ©rieure Ã  %(max)iÂ caractÃ¨res"

#: formencode/validators.py:1020
#, python-format
msgid "Enter a value %(min)i characters long or more"
msgstr "Saisissez une valeur d'au moins %(min)iÂ caractÃ¨res"

#: formencode/validators.py:1095
msgid "Invalid data or incorrect encoding"
msgstr "DonnÃ©e non valide ou codage incorrect"

#: formencode/validators.py:1267
msgid "Please enter an email address"
msgstr "Saisissez une adresse Ã©lectronique"

#: formencode/validators.py:1268
msgid "An email address must contain a single @"
msgstr "Une adresse Ã©lectronique ne doit contenir qu'un seul Â«Â @Â Â»"
...
"the @: %(username)s)"
msgstr ""
"Le nom d'utilisateur de l'adresse Ã©lectronique n'est pas valide (partie "
"avant le Â«Â @Â Â»Â : %(username)s)"
...
msgstr ""
"Une erreur est survenue lors de la tentative de connexion au serveurÂ : "
"%(error)s"
...
" @: %(domain)s)"
msgstr ""
"Le nom de domaine de l'adresse Ã©lectronique n'est pas valide (la partie "
"aprÃ¨s le Â«Â @Â Â»Â : %(domain)s)"
...
"%(domain)s)"
msgstr ""
"Le nom de domaine de l'adresse Ã©lectronique n'existe pas (la partie aprÃ¨s"
" le Â«Â @Â Â»Â : %(domain)s)"
...
msgstr ""
"Une erreur est survenue lors de la tentative d'accÃ¨s Ã  l'adresseÂ : "
"%(error)s"

#: formencode/validators.py:1415
msgid "The server responded that the page could not be found"
msgstr "Le serveur a rÃ©pondu que la page n'a pu Ãªtre trouvÃ©e"

#: formencode/validators.py:1416
#, python-format
msgid "The server responded with a bad status code (%(status)s)"
msgstr "Le serveur a rÃ©pondu avec un code de retour incorrect (%(status)s)"
...
msgstr "Vous devez saisir des minutes (aprÃ¨s un Â«Â :Â Â»)"

#: formencode/validators.py:2075
#, python-format
msgid "The %(part)s value you gave is not a number: %(number)r"
msgstr "La valeur %(part)s n'est pas un nombreÂ : %(number)r"
...
msgstr "La valeur doit Ãªtre %(true)r ou %(false)r"
...
"et FÂ ; la valeur saisie a %(length)s caractÃ¨res"
...
msgstr "Les champs ne correspondent pas (devrait Ãªtre %(match)s)"
...
msgstr "Veuillez seulement saisir un chiffre, pas d'autres caractÃ¨res"
...
msgstr "Saisissez seulement des nombres pour le mois et l'annÃ©e"
