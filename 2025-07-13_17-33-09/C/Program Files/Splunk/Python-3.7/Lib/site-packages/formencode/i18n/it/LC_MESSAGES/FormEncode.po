...
msgstr "Questo paese non Ã¨ elencato nella norma ISO 3166"
...
msgstr "Questo linguaggio non Ã¨ elencato nella norma ISO 639"
...
msgstr "Selezionare un numero che ÃƒÂ¨ %(min)s o maggior"

#: formencode/validators.py:883
#, python-format
msgid "Please enter a number that is %(max)s or smaller"
msgstr "Selezionare un numero che ÃƒÂ¨ %(max)s o piÃƒÂ¹ piccolo"
...
msgstr "Il campo {{%(key)s}} Ã¨ mancante."
