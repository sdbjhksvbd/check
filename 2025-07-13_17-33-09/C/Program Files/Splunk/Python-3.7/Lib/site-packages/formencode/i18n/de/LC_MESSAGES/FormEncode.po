...
msgstr "Bitte geben Sie eine gÃ¼ltige Postleitzahl ein (Format gemÃ¤ÃŸ BS 7666)"
...
msgstr "Bitte ein LandeskÃ¼rzel eingeben"

#: formencode/national.py:485
msgid "Please enter a state code with TWO letters"
msgstr "Bitte ein LandeskÃ¼rzel mit ZWEI Buchstaben eingeben"

#: formencode/national.py:486
msgid "That is not a valid state code"
msgstr "Das ist kein gÃ¼ltiges LandeskÃ¼rzel"
...
msgstr "Geben Sie einen Wert mit hÃ¶chstens %(maxLength)i Zeichen ein"

#: formencode/validators.py:331 formencode/validators.py:385
msgid "Invalid value (value with length expected)"
msgstr "UngÃ¼ltiger Wert (Wert mit LÃ¤nge erwartet)"
...
msgstr "Sie kÃ¶nnen hier keinen Wert eingeben"

#: formencode/validators.py:490
msgid "The input is not valid"
msgstr "Die Eingabe ist ungÃ¼ltig"
...
"%(items)s"
msgstr ""
"Meine Zuordnungsliste enthÃ¤lt nicht den Wert %(value)s. WÃ¤hlen Sie einen "
...
msgstr "Index auÃŸerhalb des Wertebereichs"
...
msgstr "Bitte geben Sie eine Zahl ein, die grÃ¶ÃŸer oder gleich %(min)s ist"
...
msgstr "Bitte einen Wert mit hÃ¶chstens %(max)i Zeichen eingeben"
...
msgstr "UngÃ¼ltige Daten oder falsche Kodierung"
...
"the @: %(username)s)"
msgstr ""
"Der Benutzername in der E-Mail-Adresse is ungÃ¼ltig (der Teil vor dem @: "
"%(username)s)"
...
" @: %(domain)s)"
msgstr ""
"Der Domainname in der E-Mail-Adresse ist ungÃ¼ltig (der Teil nach dem @: "
"%(domain)s)"
...
msgstr "Die URL muss mit http://, https:// o.Ã¤. anfangen"

#: formencode/validators.py:1410
msgid "That is not a valid URL"
msgstr "Das ist keine gÃ¼ltige URL"
...
msgstr "Sie mÃ¼ssen einen vollstÃ¤ndigen Domainnamen angeben (wie %(domain)s.com)"
...
msgstr "\"%(xri_type)s\" ist kein gÃ¼ltiger XRI-Typ"

#: formencode/validators.py:1651
#, python-format
msgid "\"%(id)s\" is not a valid OpenId (it is neither an URL nor an XRI)"
msgstr "\"%(id)s\" ist eine ungÃ¼ltige OpenId (weder URL noch XRI)"
...
msgstr "Bitte einen gÃ¼ltigen Tag eingeben"
...
msgstr "Das ist kein gÃ¼ltiger Tag (%(exception)s)"
...
msgstr "Sie mÃ¼ssen AM oder PM angeben"
...
msgstr "Wert enthÃ¤lt keine Signatur"
...
"%(char)r"
msgstr ""
"MAC-Adressen dÃ¼rfen nur 0-9 und A-F (und Doppelpunkte) enthalten, nicht "
"%(char)r"

#: formencode/validators.py:2586
#, python-format
msgid "You must give a value for %s"
msgstr "Sie mÃ¼ssen einen Wert fÃ¼r %s eingeben"

#: formencode/validators.py:2619
#, python-format
msgid "Fields do not match (should be %(match)s)"
msgstr "Felder stimmen nicht Ã¼berein (sollte %(match)s sein)"

#: formencode/validators.py:2620
msgid "Fields do not match"
msgstr "Felder stimmen nicht Ã¼berein"
...
msgstr "Sie haben keine gÃ¼ltige Nummer aus Ziffern eingegeben"

#: formencode/validators.py:2699
msgid "That number is not valid"
msgstr "Diese Nummer ist ungÃ¼ltig"
...
msgstr "Bitte nur die Zahlen fÃ¼r Monat und Jahr eingeben"

#: formencode/validators.py:2817
msgid "Invalid Expiration Date"
msgstr "UngÃ¼ltiges Ablaufdatum"

#: formencode/validators.py:2892
msgid "Please enter numbers only for credit card security code"
msgstr "Bitte nur Ziffern fÃ¼r den Sicherheitscode der Kreditkarte eingeben"

#: formencode/validators.py:2893
msgid "Invalid credit card security code length"
msgstr "UngÃ¼ltige LÃ¤nge des Sicherheitscodes der Kreditkarte"
