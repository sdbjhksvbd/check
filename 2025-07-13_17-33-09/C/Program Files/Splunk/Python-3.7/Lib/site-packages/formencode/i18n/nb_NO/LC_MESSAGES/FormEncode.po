...
msgstr "Det du fylte inn mÃ¥ vÃ¦re tekst (ikke %(type)s: %(value)r))"

#: formencode/api.py:396
msgid "The input must be a string (not None)"
msgstr "Det du fyller inn vÃ¦re tekst (ikke tomt)"
...
msgstr "Skriv inn gyldig postnummer (for format, se BS 7666)"

#: formencode/national.py:338
msgid "That country is not listed in ISO 3166"
msgstr "Det landet er ikke oppfÃ¸rt i ISO 3166"

#: formencode/national.py:393
msgid "Given postal code does not match the country's format."
msgstr "Det oppgitte postnummeret stemmer ikke overens med landets format."
...
"optionally with \"ext.####\""
msgstr ""
"Vennligst skriv inn et nummer, med retningsummer, pÃ¥ formen ###-###-####,"
" eller med \"ext.####\""
...
msgstr "Inndatafeltet %(name)s ble ikke forventet."
...
msgstr "%(object)r mÃ¥ vÃ¦re en av typene %(typeList)s"

#: formencode/validators.py:150
#, python-format
msgid "%(object)r must be of the type %(type)s"
msgstr "%(object)r mÃ¥ vÃ¦re av type %(type)s"
...
msgstr "Skriv inn en verdi som er pÃ¥ minst %(minLength)i tegn"
...
msgstr "Verdien mÃ¥ vÃ¦re en av: %(items)s (ikke %(value)r)"
...
msgstr "MÃ¥ vÃ¦re en heltallsindeks"
...
msgstr "OppfÃ¸ringen %(value)s ble ikke funnet i listen"

#: formencode/validators.py:777
#, python-format
msgid "Date must be after %(date)s"
msgstr "Datoen mÃ¥ vÃ¦re etter %(date)s"

#: formencode/validators.py:778
#, python-format
msgid "Date must be before %(date)s"
msgstr "Datoen mÃ¥ vÃ¦re fÃ¸r %(date)s"
...
msgstr "En epostadresse mÃ¥ inneholde en @"
...
"the @: %(username)s)"
msgstr "Brukernavnet i epostadressen er ugyldig (den delen fÃ¸r @: %(username)s)"
...
msgstr "Du mÃ¥ starte din URL med http://, https://, o.l."
...
msgstr "Du mÃ¥ oppgi et fullstendig domenenavn (som %(domain)s.com)"
...
msgstr "Vennligst skriv inn datoen pÃ¥ formen %(format)s"

#: formencode/validators.py:1883
msgid "Please enter a month from 1 to 12"
msgstr "Vennligst skriv inn en mÃ¥ned fra 1 til 12"
...
msgstr "Den mÃ¥neden har bare %(days)i dager"
...
msgstr "Ukjent navn pÃ¥ mÃ¥ned: %(month)s"
...
msgstr "Vennligst skriv inn et firesifferet Ã¥rstall"

#: formencode/validators.py:2070
msgid "You must indicate AM or PM"
msgstr "Du mÃ¥ indikere AM eller PM"
...
msgstr "Du mÃ¥ skrive inn sekunder"

#: formencode/validators.py:2074
msgid "You must enter minutes (after a :)"
msgstr "Du mÃ¥ skrive minutter (etter en :)"
...
msgstr "Verdien skal vÃ¦re %(true)r eller %(false)r"
...
msgstr "Du mÃ¥ oppgi en verdi for %s"

#: formencode/validators.py:2619
#, python-format
msgid "Fields do not match (should be %(match)s)"
msgstr "Feltene er ikke like (skal vÃ¦re %(match)s)"
...
msgstr "Vennligst bare skriv inn nummerene for mÃ¥ned og Ã¥r"

#: formencode/validators.py:2817
msgid "Invalid Expiration Date"
msgstr "Ugyldig utlÃ¸psdato"
...
msgstr "Ugyldig lengde pÃ¥ sikkerhetskoden til kredittkortet"
