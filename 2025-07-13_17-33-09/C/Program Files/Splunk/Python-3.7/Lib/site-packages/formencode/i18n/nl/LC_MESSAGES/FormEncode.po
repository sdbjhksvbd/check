...
msgstr "%(object)r is geen subclass van Ã©Ã©n van de types: %(subclassList)s"

#: formencode/validators.py:149
#, python-format
msgid "%(object)r must be one of the types %(typeList)s"
msgstr "%(object)r moet van Ã©Ã©n van de types %(typeList)s zijn"
...
msgstr "Waarde moet Ã©Ã©n van %(items)s zijn (niet %(value)r)"

#: formencode/validators.py:640
msgid "Choose something"
msgstr "Kies Ã©Ã©n van de opties"

#: formencode/validators.py:641
#, python-format
msgid "Enter a value from: %(items)s"
msgstr "Voer Ã©Ã©n van de volgende waarden in: %(items)s"
...
"%(items)s"
msgstr "%(value)s komt niet voor. Kies Ã©Ã©n uit %(items)s"
...
msgstr ""
"Ongeldig emailadres: een emailadres kan slechts Ã©Ã©n \"@\" teken bevatten"
...
"@: %(username)s)"
msgstr "Ongeldig emailadres: het deel vÃ³Ã³r de \"@\" is incorrect"
