...
msgstr "Palun sisestada vÃ¤Ã¤rtus"
...
msgstr "Palun sisestada postiindeks (%(format)s)"
...
msgstr "Palun sisestada osariigi kood KAHE tÃ¤hega"

#: formencode/national.py:486
msgid "That is not a valid state code"
msgstr "See pole Ãµige osariigikood"
...
"optionally with \"ext.####\""
msgstr ""
"Palun sisestada telefoninumber koos suunakoodiga kujul ###-###-####, vÃµib"
" ka koos \"ext.####\""
...
msgstr "KuupÃ¤ev peab olema tulevikus"
...
msgstr "Palun sisestada tÃ¤isarv"
...
msgstr "Palun sisestada vÃ¤Ã¤rtus, mis on lÃ¼hem kui %(max)i sÃ¼mbolit"

#: formencode/validators.py:1020
#, python-format
msgid "Enter a value %(min)i characters long or more"
msgstr "Palun sisestada vÃ¤hemalt %(min)i sÃ¼mboli pikkune vÃ¤Ã¤rtus"

#: formencode/validators.py:1095
msgid "Invalid data or incorrect encoding"
msgstr "Vigased andmed vÃµi vale kodeering"
...
msgstr "E-posti aadressi sees peab olema Ã¼ks @-mÃ¤rk"
...
"the @: %(username)s)"
msgstr ""
"E-posti aadressi kasutajatunnuse osa on vigane (enne @-mÃ¤rki olev osa: "
"%(username)s)"
...
msgstr "Serveriga Ã¼henduse vÃµtmise viga: %(error)s"
...
" @: %(domain)s)"
msgstr "E-posti aadressi domeeniosa on vigane (peale @-mÃ¤rki olev osa: %(domain)s)"
...
"%(domain)s)"
msgstr ""
"E-posti aadressi domeeni ei ole olemas (peale @-mÃ¤rki olev osa: "
"%(domain)s)"
...
msgstr "URLi poole pÃ¶Ã¶rdumisel tekkis viga: %(error)s"

#: formencode/validators.py:1415
msgid "The server responded that the page could not be found"
msgstr "Server vastas, et lehekÃ¼lge ei leitud"
...
msgstr "Palun sisestada kuupÃ¤ev kujul %(format)s"
...
msgstr "Palun mÃ¤rkida AM vÃµi PM"
...
msgstr "Sisestatud vÃ¤Ã¤rtus %(part)s ei ole arv: %(number)r"
...
msgstr "VÃ¤ljad ei klapi (peab olema %(match)s)"

#: formencode/validators.py:2620
msgid "Fields do not match"
msgstr "VÃ¤ljad ei klapi"
...
msgstr "Palun sisestada ainult numbreid, mitte mingeid muid sÃ¼mboleid"

#: formencode/validators.py:2698
msgid "You did not enter a valid number of digits"
msgstr "Ei ole sisestatud Ãµige arv numbreid"

#: formencode/validators.py:2699
msgid "That number is not valid"
msgstr "Selline arv ei kÃµlba"
