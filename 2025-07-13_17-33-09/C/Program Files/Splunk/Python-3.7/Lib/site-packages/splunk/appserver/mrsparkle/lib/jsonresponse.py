...
class MainTest(unittest.TestCase):
    def test_unit(self):
        ...
        j.addWarn("captain! we're about to collide with the iceburg!")
        ...
        self.assertEqual(j.messages[1], {'type':'WARN', 'message':"captain! we're about to collide with the iceburg!"})
