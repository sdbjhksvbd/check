...
__doc__ = """
         ...
         default_eai_parms
          ...
          app_context
                    ...
                    context and using this info for a second POST. This is now supported in the cli. Use the app_context dict to specify the uri to access and provide a helper function (which should be 
