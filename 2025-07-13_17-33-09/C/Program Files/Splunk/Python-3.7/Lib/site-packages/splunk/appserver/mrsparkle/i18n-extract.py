...
def main():
    ...
    if not splunk_home:
        ...
        sys.exit(2)
    ui_source = os.environ.get('UI_SOURCE')
    if not ui_source:
        print("UI_SOURCE environment variable was not set!")
        sys.exit(2)
    ...
    extract_from_splunk_home = locale_dir.startswith(splunk_home)
    if extract_from_splunk_home:
        # After doing an investigation of this code, this is likely never ran.
        # When doing a manual extraction, please extract from $SPLUNK_SOURCE.
        # We chose not to remove due to not being 100% sure customers aren't leveraging this somehow.
        ...
        strip = ('../../../../../', 'cfg/bundles/')
        template_dir = ui_source + '/web/search_mrsparkle'
        ...
        web_v2_dir = ui_source + '/web_v2/search_mrsparkle'
    ...
    with open(pot_output, 'w') as pot_outfile, NamedTemporaryFile() as babel_outfile_temp:
        ...
        if web_v2_dir is not None:
            args.append(web_v2_dir)
