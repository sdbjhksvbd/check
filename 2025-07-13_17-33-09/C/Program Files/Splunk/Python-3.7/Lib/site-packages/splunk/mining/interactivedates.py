...
Instruction = """INSTRUCTIONS: If a sample line does not have a timestamp, press Enter.
                ...
                while (True):
                    ...
                    if timeformat == "":
                        ...
                        if html != None:
                            ...
                            print("Unable to learn pattern.  Enter the timestamp values again.  If there is no timestamp on this line, just press Enter.")
                printQuestion("If you are satisfied that the timestamps formats have been learned, enter Control-C.")
