...
class AppNavController(BaseController):
    ...
    def _getIndividualAppNav(self, app, viewManifest, appData, navData):
        ...
        appNavObj = appnav.AppNav(app, viewManifest=viewManifest, searches=None, navData=navData, use_app_bar_performance_optimizations=use_app_bar_performance_optimizations)
