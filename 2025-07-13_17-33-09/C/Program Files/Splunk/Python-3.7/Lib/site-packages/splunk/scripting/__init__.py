...
## we know we're in the splunk world, so the user doesn't need to think about, or specify, sessionkeys, users, passwords, namespaces, etc. (user can set those if user wants to somehow refer to other apps, I suppose)
