    ...
    **/
    ...
    _getArticleTitle: function _getArticleTitle() {
      ...
      if (/ [\|\-\\\/>Â»] /.test(curTitle)) {
        ...
        if (wordCount(curTitle) < 3) curTitle = origTitle.replace(/[^\|\-\\\/>Â»]*[\|\-\\\/>Â»](.*)/gi, "$1");
    ...
    **/
    ...
    _getTextDensity: function _getTextDensity(e, tags) {
      ...
      this._forEachNode(children, function (child) {
        return childrenLength += _this2._getInnerText(child, true).length;
      });
      ...
      this._removeNodes(this._getAllNodesWithTag(e, [tag]), function (node) {
        ...
        if (!isList) {
          ...
          this._forEachNode(listNodes, function (list) {
            return listLength += _this3._getInnerText(list).length;
          });
