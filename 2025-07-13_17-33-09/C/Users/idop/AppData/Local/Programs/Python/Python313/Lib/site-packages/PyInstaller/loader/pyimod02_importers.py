...
class PyiFrozenLoader:
    ...
    def get_data(self, path):
        ...
        OSError is to be raised if the path cannot be found. The path is expected to be constructed using a moduleâ€™s
        __file__ attribute or an item from a packageâ€™s __path__.
